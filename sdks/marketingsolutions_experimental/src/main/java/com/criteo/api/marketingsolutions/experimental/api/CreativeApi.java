...
import com.criteo.api.marketingsolutions.experimental.model.ExamAdAudienceSegmentLinkInput;
import com.criteo.api.marketingsolutions.experimental.model.ResourceCollectionOutcomeOfAd;
import com.criteo.api.marketingsolutions.experimental.model.ResourceCollectionOutcomeOfCoupon;
import com.criteo.api.marketingsolutions.experimental.model.ResourceCollectionOutcomeOfCreativeRead;
import com.criteo.api.marketingsolutions.experimental.model.ResourceInputOfAdWrite;
import com.criteo.api.marketingsolutions.experimental.model.ResourceInputOfCreateCoupon;
import com.criteo.api.marketingsolutions.experimental.model.ResourceInputOfCreativeWrite;
import com.criteo.api.marketingsolutions.experimental.model.ResourceInputOfUpdateCoupon;
import com.criteo.api.marketingsolutions.experimental.model.ResourceOutcomeOfAd;
import com.criteo.api.marketingsolutions.experimental.model.ResourceOutcomeOfCoupon;
import com.criteo.api.marketingsolutions.experimental.model.ResourceOutcomeOfCouponSupportedSizes;
import com.criteo.api.marketingsolutions.experimental.model.ResourceOutcomeOfCreative;
import com.criteo.api.marketingsolutions.experimental.model.ValueResourceOutcomeOfExamAdAudienceSegmentLink;
...
public class CreativeApi {
    ...
    public okhttp3.Call createAdvertiserAdCall(String advertiserId, ResourceInputOfAdWrite resourceInputOfAdWrite, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/experimental/advertisers/{advertiser-id}/ads"
    ...
    public okhttp3.Call createAdvertiserCouponCall(String advertiserId, ResourceInputOfCreateCoupon resourceInputOfCreateCoupon, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/advertisers/{advertiser-id}/coupons"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    public okhttp3.Call createAdvertiserCreativeCall(String advertiserId, ResourceInputOfCreativeWrite resourceInputOfCreativeWrite, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/advertisers/{advertiser-id}/creatives"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    public okhttp3.Call deleteAdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/ads/{id}"
    ...
    public okhttp3.Call deleteAdSegmentLinkCall(String adId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/marketing-solutions/ads/{ad-id}/audience-segment"
    ...
    /**
     * /experimental/marketing-solutions/ads/{ad-id}/audience-segment (asynchronously)
     * Delete the link between an Ad and an Audience Segment.
     * @param adId The ad identifier. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call deleteAdvertiserCouponCall(String advertiserId, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/advertisers/{advertiser-id}/coupons/{id}"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call deleteCreativeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/creatives/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call generateCreativePreviewCall(String id, Integer height, Integer width, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/creatives/{id}/preview"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getAdvertiserCouponPreviewCall(String advertiserId, String id, Integer height, Integer width, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/advertisers/{advertiser-id}/coupons/{id}/preview"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getAdvertiserCouponSupportedSizesCall(String advertiserId, String adSetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/advertisers/{advertiser-id}/coupons-supported-sizes"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
