...
public class PatchCampaignScheduledSpendLimitCreation {
  ...
  public PatchCampaignScheduledSpendLimitCreation() {
  }

  public PatchCampaignScheduledSpendLimitCreation spendLimitAmount(NillableDecimal spendLimitAmount) {
  ...
  **/
  ...
  public PatchCampaignScheduledSpendLimitCreation spendLimitRenewal(SpendLimitRenewalEnum spendLimitRenewal) {
  ...
  **/
  ...
  public PatchCampaignScheduledSpendLimitCreation spendLimitType(SpendLimitTypeEnum spendLimitType) {
  ...
  **/
  ...
  public PatchCampaignScheduledSpendLimitCreation startDate(LocalDate startDate) {
  ...
  **/
   ...
   * @return the PatchCampaignScheduledSpendLimitCreation instance itself
   */
  public PatchCampaignScheduledSpendLimitCreation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchCampaignScheduledSpendLimitCreation patchCampaignScheduledSpendLimitCreation = (PatchCampaignScheduledSpendLimitCreation) o;
    return Objects.equals(this.spendLimitAmount, patchCampaignScheduledSpendLimitCreation.spendLimitAmount) &&
        Objects.equals(this.spendLimitRenewal, patchCampaignScheduledSpendLimitCreation.spendLimitRenewal) &&
        Objects.equals(this.spendLimitType, patchCampaignScheduledSpendLimitCreation.spendLimitType) &&
        Objects.equals(this.startDate, patchCampaignScheduledSpendLimitCreation.startDate)&&
        Objects.equals(this.additionalProperties, patchCampaignScheduledSpendLimitCreation.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(spendLimitAmount, spendLimitRenewal, spendLimitType, startDate, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchCampaignScheduledSpendLimitCreation {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchCampaignScheduledSpendLimitCreation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchCampaignScheduledSpendLimitCreation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchCampaignScheduledSpendLimitCreation is not found in the empty JSON string", PatchCampaignScheduledSpendLimitCreation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchCampaignScheduledSpendLimitCreation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchCampaignScheduledSpendLimitCreation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchCampaignScheduledSpendLimitCreation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchCampaignScheduledSpendLimitCreation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchCampaignScheduledSpendLimitCreation.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchCampaignScheduledSpendLimitCreation>() {
           @Override
           public void write(JsonWriter out, PatchCampaignScheduledSpendLimitCreation value) throws IOException {
           ...
           @Override
           public PatchCampaignScheduledSpendLimitCreation read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchCampaignScheduledSpendLimitCreation instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchCampaignScheduledSpendLimitCreation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchCampaignScheduledSpendLimitCreation
  * @throws IOException if the JSON string is invalid with respect to PatchCampaignScheduledSpendLimitCreation
  */
  public static PatchCampaignScheduledSpendLimitCreation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchCampaignScheduledSpendLimitCreation.class);
  }

 /**
  * Convert an instance of PatchCampaignScheduledSpendLimitCreation to an JSON string
  *
  * @return JSON string
  */
