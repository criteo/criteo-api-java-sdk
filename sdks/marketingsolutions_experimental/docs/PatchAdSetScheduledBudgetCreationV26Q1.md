...
|------------ | ------------- | ------------- | -------------|
|**budgetAmount** | **Double** | Maximum budget amount in the advertiser&#39;s currency per renewal period.  Required when budgetStrategy is \&quot;capped\&quot;; must be omitted when budgetStrategy is \&quot;uncapped\&quot;. |  [optional] |
...
|**startDate** | **LocalDate** | Advertiser-local calendar date when the scheduled budget becomes active. Required, strictly in the future. |  |
