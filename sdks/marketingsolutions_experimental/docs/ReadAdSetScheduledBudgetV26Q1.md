...
|------------ | ------------- | ------------- | -------------|
|**budgetAmount** | **Double** | Maximum budget amount in the advertiser&#39;s currency per renewal period. Non-null when capped. null when uncapped. |  [optional] |
...
|**id** | **String** | Identifier of the scheduled budget. |  [optional] |
...
|**startDate** | **LocalDate** | Advertiser-local calendar date when the scheduled budget becomes active. |  [optional] |
