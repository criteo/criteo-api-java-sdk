...
import com.criteo.api.retailmedia.v2024_07.model.Creative202210ListResponse;
...
import com.criteo.api.retailmedia.v2024_07.model.JsonApiSingleResponseOfLineItemBidMultipliers;
...
import com.criteo.api.retailmedia.v2024_07.model.LineItemBidMultipliersRequest;
import com.criteo.api.retailmedia.v2024_07.model.LineItemBidMultipliersResponse;
import com.criteo.api.retailmedia.v2024_07.model.PostCampaignV202301;
import com.criteo.api.retailmedia.v2024_07.model.PreferredLineItem202110PagedListResponse;
import com.criteo.api.retailmedia.v2024_07.model.PreferredLineItem202110Response;
import com.criteo.api.retailmedia.v2024_07.model.PreferredLineItemCreateModel202110Request;
import com.criteo.api.retailmedia.v2024_07.model.PreferredLineItemUpdateModel202110Request;
import com.criteo.api.retailmedia.v2024_07.model.PromotedProduct202110ListRequest;
import com.criteo.api.retailmedia.v2024_07.model.PromotedProduct202110PagedListResponse;
import com.criteo.api.retailmedia.v2024_07.model.ProposalStatusModelResponse;
...
public class CampaignApi {
    ...
    public okhttp3.Call fetchProposalCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-07/retail-media/preferred-deal-line-items/{id}/proposal"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getApi202110ExternalCampaignPreferredLineItemsByCampaignIdCall(String campaignId, List<String> limitToId, Integer pageIndex, Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-07/retail-media/campaigns/{campaign-id}/preferred-line-items"
    ...
    public okhttp3.Call getApi202110ExternalPreferredLineItemByLineItemIdCall(String lineItemId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-07/retail-media/preferred-line-items/{line-item-id}"
            .replace("{" + "line-item-id" + "}", localVarApiClient.escapeString(lineItemId.toString()));
    ...
    public okhttp3.Call getApi202301ExternalLineItemBidMultipliersByLineItemIdCall(String lineItemId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-07/retail-media/line-items/{line-item-id}/bid-multipliers"
            .replace("{" + "line-item-id" + "}", localVarApiClient.escapeString(lineItemId.toString()));
    ...
    public okhttp3.Call postApi202210ExternalAccountCreativesSearchByAccountIdCall(String accountId, List<String> creativeIds, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-07/retail-media/accounts/{account-id}/creatives/search"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call submitProposalCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-07/retail-media/preferred-deal-line-items/{id}/proposal/submit"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
