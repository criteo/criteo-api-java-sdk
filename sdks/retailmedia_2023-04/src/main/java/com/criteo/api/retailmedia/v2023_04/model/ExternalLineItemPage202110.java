...
import com.criteo.api.retailmedia.v2023_04.model.ExternalLineItemPageCategory202110;
...
public class ExternalLineItemPage202110 {
  ...
  **/
   ...
   * @return the ExternalLineItemPage202110 instance itself
   */
  public ExternalLineItemPage202110 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExternalLineItemPage202110
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExternalLineItemPage202110.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExternalLineItemPage202110 is not found in the empty JSON string", ExternalLineItemPage202110.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExternalLineItemPage202110.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExternalLineItemPage202110.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExternalLineItemPage202110' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExternalLineItemPage202110> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExternalLineItemPage202110.class));

       return (TypeAdapter<T>) new TypeAdapter<ExternalLineItemPage202110>() {
           @Override
           public void write(JsonWriter out, ExternalLineItemPage202110 value) throws IOException {
           ...
           @Override
           public ExternalLineItemPage202110 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExternalLineItemPage202110 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExternalLineItemPage202110 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExternalLineItemPage202110
  * @throws IOException if the JSON string is invalid with respect to ExternalLineItemPage202110
  */
  public static ExternalLineItemPage202110 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExternalLineItemPage202110.class);
  }

 /**
  * Convert an instance of ExternalLineItemPage202110 to an JSON string
  *
  * @return JSON string
  */
