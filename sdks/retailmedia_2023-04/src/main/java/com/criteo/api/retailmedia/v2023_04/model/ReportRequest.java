...
import com.criteo.api.retailmedia.v2023_04.model.ReportRequestAttributes;
...
public class ReportRequest {
  ...
  **/
   ...
   * @return the ReportRequest instance itself
   */
  public ReportRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, reportRequest.attributes) &&
        ...
        Objects.equals(this.additionalProperties, reportRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReportRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      ReportRequestAttributes.validateJsonObject(jsonObj.getAsJsonObject("attributes"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReportRequest>() {
           ...
           public ReportRequest read(JsonReader in) throws IOException {
             ...
             ReportRequest instance = thisAdapter.fromJsonTree(jsonObj);
