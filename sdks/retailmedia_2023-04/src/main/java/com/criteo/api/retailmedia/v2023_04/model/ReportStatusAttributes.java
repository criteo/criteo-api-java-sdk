...
public class ReportStatusAttributes {
  ...
  **/
   ...
   * @return the ReportStatusAttributes instance itself
   */
  public ReportStatusAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, reportStatusAttributes.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, reportStatusAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, expiresAt, fileSizeBytes, md5Checksum, message, rowCount, status, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReportStatusAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportStatusAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportStatusAttributes is not found in the empty JSON string", ReportStatusAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportStatusAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportStatusAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportStatusAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportStatusAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportStatusAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportStatusAttributes>() {
           @Override
           public void write(JsonWriter out, ReportStatusAttributes value) throws IOException {
           ...
           @Override
           public ReportStatusAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReportStatusAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReportStatusAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportStatusAttributes
  * @throws IOException if the JSON string is invalid with respect to ReportStatusAttributes
  */
  public static ReportStatusAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportStatusAttributes.class);
  }

 /**
  * Convert an instance of ReportStatusAttributes to an JSON string
  *
  * @return JSON string
  */
