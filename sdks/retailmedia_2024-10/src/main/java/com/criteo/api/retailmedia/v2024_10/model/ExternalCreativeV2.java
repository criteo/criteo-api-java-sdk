...
import com.criteo.api.retailmedia.v2024_10.model.ExternalPageTypeEnvironment;
import com.criteo.api.retailmedia.v2024_10.model.ExternalTemplateVariableValue;
...
public class ExternalCreativeV2 {
  ...
  private List<ExternalPageTypeEnvironment> environments = new ArrayList<>();
  ...
  private List<ExternalTemplateVariableValue> templateVariableValues = new ArrayList<>();

  public ExternalCreativeV2() {
  }

  public ExternalCreativeV2 name(String name) {
  ...
  **/
  ...
  public ExternalCreativeV2 status(StatusEnum status) {
  ...
  **/
  ...
  public ExternalCreativeV2 brandId(Long brandId) {
  ...
  **/
  ...
  public ExternalCreativeV2 retailerId(Integer retailerId) {
  ...
  **/
  ...
  public ExternalCreativeV2 templateId(Integer templateId) {
  ...
  **/
  ...
  public ExternalCreativeV2 templateName(String templateName) {
  ...
  **/
  ...
  public ExternalCreativeV2 formatId(Integer formatId) {
  ...
  **/
  ...
  public ExternalCreativeV2 associatedLineItemIds(List<String> associatedLineItemIds) {
    
    this.associatedLineItemIds = associatedLineItemIds;
    return this;
  }

  public ExternalCreativeV2 addAssociatedLineItemIdsItem(String associatedLineItemIdsItem) {
  ...
  **/
  ...
  public ExternalCreativeV2 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ExternalCreativeV2 creativeFormatType(CreativeFormatTypeEnum creativeFormatType) {
  ...
  **/
  ...
  public ExternalCreativeV2 environments(List<ExternalPageTypeEnvironment> environments) {
    
    this.environments = environments;
    return this;
  }

  public ExternalCreativeV2 addEnvironmentsItem(ExternalPageTypeEnvironment environmentsItem) {
  ...
  **/
  ...
  public List<ExternalPageTypeEnvironment> getEnvironments() {
    return environments;
  }


  public void setEnvironments(List<ExternalPageTypeEnvironment> environments) {
    this.environments = environments;
  }


  public ExternalCreativeV2 templateVariableValues(List<ExternalTemplateVariableValue> templateVariableValues) {
    
    this.templateVariableValues = templateVariableValues;
    return this;
  }

  public ExternalCreativeV2 addTemplateVariableValuesItem(ExternalTemplateVariableValue templateVariableValuesItem) {
  ...
  **/
  ...
  public List<ExternalTemplateVariableValue> getTemplateVariableValues() {
    return templateVariableValues;
  }


  public void setTemplateVariableValues(List<ExternalTemplateVariableValue> templateVariableValues) {
    this.templateVariableValues = templateVariableValues;
  }
   ...
   * @return the ExternalCreativeV2 instance itself
   */
  public ExternalCreativeV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExternalCreativeV2 externalCreativeV2 = (ExternalCreativeV2) o;
    return Objects.equals(this.name, externalCreativeV2.name) &&
        Objects.equals(this.status, externalCreativeV2.status) &&
        Objects.equals(this.brandId, externalCreativeV2.brandId) &&
        Objects.equals(this.retailerId, externalCreativeV2.retailerId) &&
        Objects.equals(this.templateId, externalCreativeV2.templateId) &&
        Objects.equals(this.templateName, externalCreativeV2.templateName) &&
        Objects.equals(this.formatId, externalCreativeV2.formatId) &&
        Objects.equals(this.associatedLineItemIds, externalCreativeV2.associatedLineItemIds) &&
        Objects.equals(this.updatedAt, externalCreativeV2.updatedAt) &&
        Objects.equals(this.creativeFormatType, externalCreativeV2.creativeFormatType) &&
        Objects.equals(this.environments, externalCreativeV2.environments) &&
        Objects.equals(this.templateVariableValues, externalCreativeV2.templateVariableValues)&&
        Objects.equals(this.additionalProperties, externalCreativeV2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalCreativeV2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExternalCreativeV2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExternalCreativeV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExternalCreativeV2 is not found in the empty JSON string", ExternalCreativeV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExternalCreativeV2.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayenvironments.size(); i++) {
        ExternalPageTypeEnvironment.validateJsonObject(jsonArrayenvironments.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraytemplateVariableValues.size(); i++) {
        ExternalTemplateVariableValue.validateJsonObject(jsonArraytemplateVariableValues.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExternalCreativeV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExternalCreativeV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExternalCreativeV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExternalCreativeV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ExternalCreativeV2>() {
           @Override
           public void write(JsonWriter out, ExternalCreativeV2 value) throws IOException {
           ...
           @Override
           public ExternalCreativeV2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExternalCreativeV2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExternalCreativeV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExternalCreativeV2
  * @throws IOException if the JSON string is invalid with respect to ExternalCreativeV2
  */
  public static ExternalCreativeV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExternalCreativeV2.class);
  }

 /**
  * Convert an instance of ExternalCreativeV2 to an JSON string
  *
  * @return JSON string
  */
