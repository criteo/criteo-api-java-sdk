...
import com.criteo.api.retailmedia.v2024_10.model.AsyncCampaignsReportRequest;
import com.criteo.api.retailmedia.v2024_10.model.AsyncLineItemsReportRequest;
import com.criteo.api.retailmedia.v2024_10.model.AsyncReportResponse;
import com.criteo.api.retailmedia.v2024_10.model.AsyncRevenueReportRequest;
import java.io.File;
import com.criteo.api.retailmedia.v2024_10.model.ReportOutcome;
...
public class AnalyticsApi {
    ...
    public okhttp3.Call generateAsyncLineItemsReportCall(AsyncLineItemsReportRequest asyncLineItemsReportRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-10/retail-media/reports/line-items";
    ...
    public okhttp3.Call generateAsyncRevenueReportCall(AsyncRevenueReportRequest asyncRevenueReportRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-10/retail-media/reports/revenue";
    ...
    public okhttp3.Call getAsyncExportOutputCall(String reportId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-10/retail-media/reports/{reportId}/output"
    ...
    public okhttp3.Call getAsyncExportStatusCall(String reportId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2024-10/retail-media/reports/{reportId}/status"
            .replace("{" + "reportId" + "}", localVarApiClient.escapeString(reportId.toString()));
