...
public class RmAudienceSearchEntityV1 {
  ...
  public RmAudienceSearchEntityV1 audienceIds(List<String> audienceIds) {
  ...
  **/
   ...
   * @return the RmAudienceSearchEntityV1 instance itself
   */
  public RmAudienceSearchEntityV1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RmAudienceSearchEntityV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RmAudienceSearchEntityV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmAudienceSearchEntityV1 is not found in the empty JSON string", RmAudienceSearchEntityV1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmAudienceSearchEntityV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmAudienceSearchEntityV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmAudienceSearchEntityV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmAudienceSearchEntityV1.class));

       return (TypeAdapter<T>) new TypeAdapter<RmAudienceSearchEntityV1>() {
           @Override
           public void write(JsonWriter out, RmAudienceSearchEntityV1 value) throws IOException {
           ...
           @Override
           public RmAudienceSearchEntityV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RmAudienceSearchEntityV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RmAudienceSearchEntityV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RmAudienceSearchEntityV1
  * @throws IOException if the JSON string is invalid with respect to RmAudienceSearchEntityV1
  */
  public static RmAudienceSearchEntityV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmAudienceSearchEntityV1.class);
  }

 /**
  * Convert an instance of RmAudienceSearchEntityV1 to an JSON string
  *
  * @return JSON string
  */
