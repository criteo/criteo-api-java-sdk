...
public class ReadAdSetScheduledBudgetV26Q1 {
  ...
  /**
   * Controls how a standard capped budget is paced.  - \&quot;targetFullBudget\&quot;: spend toward the full budget amount within the renewal period.  - \&quot;targetAverageDailyBudget\&quot;: spend toward an average daily amount. Only supported for capped, standard, monthly budgets.  - \&quot;undefined\&quot;: no explicit pacing behavior. Use for uncapped or accelerated budgets, or omit pacingBehavior.
   */
  ...
  public ReadAdSetScheduledBudgetV26Q1() {
  }

  public ReadAdSetScheduledBudgetV26Q1 budgetAmount(Double budgetAmount) {
   ...
   /**
   * Maximum budget amount in the advertiser&#39;s currency per renewal period. Non-null when capped. null when uncapped.
   * @return budgetAmount
  **/
  ...
  public ReadAdSetScheduledBudgetV26Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public ReadAdSetScheduledBudgetV26Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public ReadAdSetScheduledBudgetV26Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public ReadAdSetScheduledBudgetV26Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
  ...
  public ReadAdSetScheduledBudgetV26Q1 id(String id) {
   ...
   /**
   * Identifier of the scheduled budget.
   * @return id
  **/
  @javax.annotation.Nullable
  ...
  public ReadAdSetScheduledBudgetV26Q1 pacingBehavior(PacingBehaviorEnum pacingBehavior) {
  ...
  **/
  ...
  public ReadAdSetScheduledBudgetV26Q1 startDate(LocalDate startDate) {
   ...
   /**
   * Advertiser-local calendar date when the scheduled budget becomes active.
   * @return startDate
  **/
  @javax.annotation.Nullable
   ...
   * @return the ReadAdSetScheduledBudgetV26Q1 instance itself
   */
  public ReadAdSetScheduledBudgetV26Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReadAdSetScheduledBudgetV26Q1 readAdSetScheduledBudgetV26Q1 = (ReadAdSetScheduledBudgetV26Q1) o;
    return Objects.equals(this.budgetAmount, readAdSetScheduledBudgetV26Q1.budgetAmount) &&
        Objects.equals(this.budgetDeliverySmoothing, readAdSetScheduledBudgetV26Q1.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, readAdSetScheduledBudgetV26Q1.budgetDeliveryWeek) &&
        Objects.equals(this.budgetRenewal, readAdSetScheduledBudgetV26Q1.budgetRenewal) &&
        Objects.equals(this.budgetStrategy, readAdSetScheduledBudgetV26Q1.budgetStrategy) &&
        Objects.equals(this.id, readAdSetScheduledBudgetV26Q1.id) &&
        Objects.equals(this.pacingBehavior, readAdSetScheduledBudgetV26Q1.pacingBehavior) &&
        Objects.equals(this.startDate, readAdSetScheduledBudgetV26Q1.startDate)&&
        Objects.equals(this.additionalProperties, readAdSetScheduledBudgetV26Q1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReadAdSetScheduledBudgetV26Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadAdSetScheduledBudgetV26Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadAdSetScheduledBudgetV26Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadAdSetScheduledBudgetV26Q1 is not found in the empty JSON string", ReadAdSetScheduledBudgetV26Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadAdSetScheduledBudgetV26Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadAdSetScheduledBudgetV26Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadAdSetScheduledBudgetV26Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadAdSetScheduledBudgetV26Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadAdSetScheduledBudgetV26Q1>() {
           @Override
           public void write(JsonWriter out, ReadAdSetScheduledBudgetV26Q1 value) throws IOException {
           ...
           @Override
           public ReadAdSetScheduledBudgetV26Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReadAdSetScheduledBudgetV26Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReadAdSetScheduledBudgetV26Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadAdSetScheduledBudgetV26Q1
  * @throws IOException if the JSON string is invalid with respect to ReadAdSetScheduledBudgetV26Q1
  */
  public static ReadAdSetScheduledBudgetV26Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadAdSetScheduledBudgetV26Q1.class);
  }

 /**
  * Convert an instance of ReadAdSetScheduledBudgetV26Q1 to an JSON string
  *
  * @return JSON string
  */
