...
public class PatchAdSetBudgetV26Q1 {
  ...
  public PatchAdSetBudgetV26Q1() {
  }

  public PatchAdSetBudgetV26Q1 budgetAmount(NillableDecimal budgetAmount) {
  ...
  **/
  ...
  public PatchAdSetBudgetV26Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public PatchAdSetBudgetV26Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public PatchAdSetBudgetV26Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public PatchAdSetBudgetV26Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
   ...
   * @return the PatchAdSetBudgetV26Q1 instance itself
   */
  public PatchAdSetBudgetV26Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchAdSetBudgetV26Q1 patchAdSetBudgetV26Q1 = (PatchAdSetBudgetV26Q1) o;
    return Objects.equals(this.budgetAmount, patchAdSetBudgetV26Q1.budgetAmount) &&
        Objects.equals(this.budgetDeliverySmoothing, patchAdSetBudgetV26Q1.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, patchAdSetBudgetV26Q1.budgetDeliveryWeek) &&
        Objects.equals(this.budgetRenewal, patchAdSetBudgetV26Q1.budgetRenewal) &&
        Objects.equals(this.budgetStrategy, patchAdSetBudgetV26Q1.budgetStrategy)&&
        Objects.equals(this.additionalProperties, patchAdSetBudgetV26Q1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchAdSetBudgetV26Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchAdSetBudgetV26Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchAdSetBudgetV26Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchAdSetBudgetV26Q1 is not found in the empty JSON string", PatchAdSetBudgetV26Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAdSetBudgetV26Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAdSetBudgetV26Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAdSetBudgetV26Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAdSetBudgetV26Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAdSetBudgetV26Q1>() {
           @Override
           public void write(JsonWriter out, PatchAdSetBudgetV26Q1 value) throws IOException {
           ...
           @Override
           public PatchAdSetBudgetV26Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchAdSetBudgetV26Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchAdSetBudgetV26Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchAdSetBudgetV26Q1
  * @throws IOException if the JSON string is invalid with respect to PatchAdSetBudgetV26Q1
  */
  public static PatchAdSetBudgetV26Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAdSetBudgetV26Q1.class);
  }

 /**
  * Convert an instance of PatchAdSetBudgetV26Q1 to an JSON string
  *
  * @return JSON string
  */
