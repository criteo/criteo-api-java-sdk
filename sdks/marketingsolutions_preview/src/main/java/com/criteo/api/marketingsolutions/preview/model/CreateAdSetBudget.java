...
public class CreateAdSetBudget {
  ...
  **/
   ...
   * @return the CreateAdSetBudget instance itself
   */
  public CreateAdSetBudget putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.budgetStrategy, createAdSetBudget.budgetStrategy) &&
        ...
        Objects.equals(this.additionalProperties, createAdSetBudget.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAdSetBudget
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateAdSetBudget.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAdSetBudget is not found in the empty JSON string", CreateAdSetBudget.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAdSetBudget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAdSetBudget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAdSetBudget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAdSetBudget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAdSetBudget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAdSetBudget>() {
           @Override
           public void write(JsonWriter out, CreateAdSetBudget value) throws IOException {
           ...
           @Override
           public CreateAdSetBudget read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateAdSetBudget instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateAdSetBudget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAdSetBudget
  * @throws IOException if the JSON string is invalid with respect to CreateAdSetBudget
  */
  public static CreateAdSetBudget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAdSetBudget.class);
  }

 /**
  * Convert an instance of CreateAdSetBudget to an JSON string
  *
  * @return JSON string
  */
