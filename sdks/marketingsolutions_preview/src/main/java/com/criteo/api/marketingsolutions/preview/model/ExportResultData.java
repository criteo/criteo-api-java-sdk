...
public class ExportResultData {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, exportResultData.data) &&
        Objects.equals(this.metadata, exportResultData.metadata);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ExportResultData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportResultData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
