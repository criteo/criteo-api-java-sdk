...
public class ReadAdSetBudgetV26Q1 {
  ...
  public ReadAdSetBudgetV26Q1 budgetAmount(Double budgetAmount) {
  ...
  **/
  ...
  public ReadAdSetBudgetV26Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public ReadAdSetBudgetV26Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public ReadAdSetBudgetV26Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public ReadAdSetBudgetV26Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
   ...
   * @return the ReadAdSetBudgetV26Q1 instance itself
   */
  public ReadAdSetBudgetV26Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReadAdSetBudgetV26Q1 readAdSetBudgetV26Q1 = (ReadAdSetBudgetV26Q1) o;
    return Objects.equals(this.budgetAmount, readAdSetBudgetV26Q1.budgetAmount) &&
  ...
  public String toString() {
    ...
    sb.append("class ReadAdSetBudgetV26Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadAdSetBudgetV26Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadAdSetBudgetV26Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadAdSetBudgetV26Q1 is not found in the empty JSON string", ReadAdSetBudgetV26Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadAdSetBudgetV26Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadAdSetBudgetV26Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadAdSetBudgetV26Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadAdSetBudgetV26Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadAdSetBudgetV26Q1>() {
           @Override
           public void write(JsonWriter out, ReadAdSetBudgetV26Q1 value) throws IOException {
           ...
           @Override
           public ReadAdSetBudgetV26Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReadAdSetBudgetV26Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReadAdSetBudgetV26Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadAdSetBudgetV26Q1
  * @throws IOException if the JSON string is invalid with respect to ReadAdSetBudgetV26Q1
  */
  public static ReadAdSetBudgetV26Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadAdSetBudgetV26Q1.class);
  }

 /**
  * Convert an instance of ReadAdSetBudgetV26Q1 to an JSON string
  *
  * @return JSON string
  */
