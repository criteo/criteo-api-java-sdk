...
public class ReadAdSetBudgetV24Q3 {
  /**
  ...
  public ReadAdSetBudgetV24Q3() {
  }

  public ReadAdSetBudgetV24Q3 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q3 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q3 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q3 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q3 budgetAmount(Double budgetAmount) {
  ...
  **/
   ...
   * @return the ReadAdSetBudgetV24Q3 instance itself
   */
  public ReadAdSetBudgetV24Q3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReadAdSetBudgetV24Q3 readAdSetBudgetV24Q3 = (ReadAdSetBudgetV24Q3) o;
    return Objects.equals(this.budgetStrategy, readAdSetBudgetV24Q3.budgetStrategy) &&
        Objects.equals(this.budgetRenewal, readAdSetBudgetV24Q3.budgetRenewal) &&
        Objects.equals(this.budgetDeliverySmoothing, readAdSetBudgetV24Q3.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, readAdSetBudgetV24Q3.budgetDeliveryWeek) &&
        Objects.equals(this.budgetAmount, readAdSetBudgetV24Q3.budgetAmount)&&
        Objects.equals(this.additionalProperties, readAdSetBudgetV24Q3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadAdSetBudgetV24Q3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadAdSetBudgetV24Q3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadAdSetBudgetV24Q3 is not found in the empty JSON string", ReadAdSetBudgetV24Q3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadAdSetBudgetV24Q3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadAdSetBudgetV24Q3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadAdSetBudgetV24Q3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadAdSetBudgetV24Q3.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadAdSetBudgetV24Q3>() {
           @Override
           public void write(JsonWriter out, ReadAdSetBudgetV24Q3 value) throws IOException {
           ...
           @Override
           public ReadAdSetBudgetV24Q3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReadAdSetBudgetV24Q3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReadAdSetBudgetV24Q3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadAdSetBudgetV24Q3
  * @throws IOException if the JSON string is invalid with respect to ReadAdSetBudgetV24Q3
  */
  public static ReadAdSetBudgetV24Q3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadAdSetBudgetV24Q3.class);
  }

 /**
  * Convert an instance of ReadAdSetBudgetV24Q3 to an JSON string
  *
  * @return JSON string
  */
