 ...
 */
@ApiModel(description = "ad set bidding create model")
...
public class CreateAdSetBidding {
  ...
  **/
  ...
  @ApiModelProperty(value = "Decimal value target relating to the `bidStrategy` specified. May be `null` for strategies that do not require a target value. At most 4 decimals are supported. Additional decimals are rounded.")
