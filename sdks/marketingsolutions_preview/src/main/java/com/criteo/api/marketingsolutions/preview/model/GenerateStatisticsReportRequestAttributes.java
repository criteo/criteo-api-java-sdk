...
public class GenerateStatisticsReportRequestAttributes {
  ...
  public GenerateStatisticsReportRequestAttributes() {
  }
  ...
  **/
   ...
   * @return the GenerateStatisticsReportRequestAttributes instance itself
   */
  public GenerateStatisticsReportRequestAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startDate, generateStatisticsReportRequestAttributes.startDate) &&
        ...
        Objects.equals(this.additionalProperties, generateStatisticsReportRequestAttributes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startDate, endDate, advertiserIds, timezone, dimensions, metrics, currency, adSetIds, adSetNames, adSetStatus, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateStatisticsReportRequestAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateStatisticsReportRequestAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateStatisticsReportRequestAttributes is not found in the empty JSON string", GenerateStatisticsReportRequestAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateStatisticsReportRequestAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateStatisticsReportRequestAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateStatisticsReportRequestAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateStatisticsReportRequestAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateStatisticsReportRequestAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateStatisticsReportRequestAttributes>() {
           @Override
           public void write(JsonWriter out, GenerateStatisticsReportRequestAttributes value) throws IOException {
           ...
           @Override
           public GenerateStatisticsReportRequestAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GenerateStatisticsReportRequestAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GenerateStatisticsReportRequestAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateStatisticsReportRequestAttributes
  * @throws IOException if the JSON string is invalid with respect to GenerateStatisticsReportRequestAttributes
  */
  public static GenerateStatisticsReportRequestAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateStatisticsReportRequestAttributes.class);
  }

 /**
  * Convert an instance of GenerateStatisticsReportRequestAttributes to an JSON string
  *
  * @return JSON string
  */
