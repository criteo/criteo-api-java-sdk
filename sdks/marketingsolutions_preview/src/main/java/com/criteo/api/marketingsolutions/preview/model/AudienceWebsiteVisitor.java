 ...
 */
@ApiModel(description = "website visitor audience configuration of the ad set")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class AudienceWebsiteVisitor {
  /**
  ...
  public AudienceWebsiteVisitor visitorTypes(List<VisitorTypesEnum> visitorTypes) {
    
    this.visitorTypes = visitorTypes;
    return this;
  }

  public AudienceWebsiteVisitor addVisitorTypesItem(VisitorTypesEnum visitorTypesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AudienceWebsiteVisitor audienceWebsiteVisitor = (AudienceWebsiteVisitor) o;
    return Objects.equals(this.visitorTypes, audienceWebsiteVisitor.visitorTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(visitorTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AudienceWebsiteVisitor {\n");
