...
public class ReadAdSetBudgetV24Q1 {
  /**
  ...
  public ReadAdSetBudgetV24Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public ReadAdSetBudgetV24Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
   ...
   * @return the ReadAdSetBudgetV24Q1 instance itself
   */
  public ReadAdSetBudgetV24Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReadAdSetBudgetV24Q1 readAdSetBudgetV24Q1 = (ReadAdSetBudgetV24Q1) o;
    return Objects.equals(this.budgetStrategy, readAdSetBudgetV24Q1.budgetStrategy) &&
        Objects.equals(this.budgetRenewal, readAdSetBudgetV24Q1.budgetRenewal) &&
        Objects.equals(this.budgetDeliverySmoothing, readAdSetBudgetV24Q1.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, readAdSetBudgetV24Q1.budgetDeliveryWeek) &&
        Objects.equals(this.budgetAmount, readAdSetBudgetV24Q1.budgetAmount)&&
        Objects.equals(this.additionalProperties, readAdSetBudgetV24Q1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadAdSetBudgetV24Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadAdSetBudgetV24Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadAdSetBudgetV24Q1 is not found in the empty JSON string", ReadAdSetBudgetV24Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadAdSetBudgetV24Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadAdSetBudgetV24Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadAdSetBudgetV24Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadAdSetBudgetV24Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadAdSetBudgetV24Q1>() {
           @Override
           public void write(JsonWriter out, ReadAdSetBudgetV24Q1 value) throws IOException {
           ...
           @Override
           public ReadAdSetBudgetV24Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReadAdSetBudgetV24Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReadAdSetBudgetV24Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadAdSetBudgetV24Q1
  * @throws IOException if the JSON string is invalid with respect to ReadAdSetBudgetV24Q1
  */
  public static ReadAdSetBudgetV24Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadAdSetBudgetV24Q1.class);
  }

 /**
  * Convert an instance of ReadAdSetBudgetV24Q1 to an JSON string
  *
  * @return JSON string
  */
