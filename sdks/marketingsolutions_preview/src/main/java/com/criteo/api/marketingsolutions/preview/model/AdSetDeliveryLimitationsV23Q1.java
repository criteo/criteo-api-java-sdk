...
public class AdSetDeliveryLimitationsV23Q1 {
  /**
  ...
  public AdSetDeliveryLimitationsV23Q1() {
  }

  public AdSetDeliveryLimitationsV23Q1 environments(List<EnvironmentsEnum> environments) {
    
    this.environments = environments;
    return this;
  }

  public AdSetDeliveryLimitationsV23Q1 addEnvironmentsItem(EnvironmentsEnum environmentsItem) {
  ...
  **/
  ...
  public AdSetDeliveryLimitationsV23Q1 devices(List<DevicesEnum> devices) {
    
    this.devices = devices;
    return this;
  }

  public AdSetDeliveryLimitationsV23Q1 addDevicesItem(DevicesEnum devicesItem) {
  ...
  **/
  ...
  public AdSetDeliveryLimitationsV23Q1 operatingSystems(List<OperatingSystemsEnum> operatingSystems) {
    
    this.operatingSystems = operatingSystems;
    return this;
  }

  public AdSetDeliveryLimitationsV23Q1 addOperatingSystemsItem(OperatingSystemsEnum operatingSystemsItem) {
  ...
  **/
   ...
   * @return the AdSetDeliveryLimitationsV23Q1 instance itself
   */
  public AdSetDeliveryLimitationsV23Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AdSetDeliveryLimitationsV23Q1 adSetDeliveryLimitationsV23Q1 = (AdSetDeliveryLimitationsV23Q1) o;
    return Objects.equals(this.environments, adSetDeliveryLimitationsV23Q1.environments) &&
        Objects.equals(this.devices, adSetDeliveryLimitationsV23Q1.devices) &&
        Objects.equals(this.operatingSystems, adSetDeliveryLimitationsV23Q1.operatingSystems)&&
        Objects.equals(this.additionalProperties, adSetDeliveryLimitationsV23Q1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdSetDeliveryLimitationsV23Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdSetDeliveryLimitationsV23Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdSetDeliveryLimitationsV23Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdSetDeliveryLimitationsV23Q1 is not found in the empty JSON string", AdSetDeliveryLimitationsV23Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdSetDeliveryLimitationsV23Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdSetDeliveryLimitationsV23Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdSetDeliveryLimitationsV23Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdSetDeliveryLimitationsV23Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<AdSetDeliveryLimitationsV23Q1>() {
           @Override
           public void write(JsonWriter out, AdSetDeliveryLimitationsV23Q1 value) throws IOException {
           ...
           @Override
           public AdSetDeliveryLimitationsV23Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AdSetDeliveryLimitationsV23Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AdSetDeliveryLimitationsV23Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AdSetDeliveryLimitationsV23Q1
  * @throws IOException if the JSON string is invalid with respect to AdSetDeliveryLimitationsV23Q1
  */
  public static AdSetDeliveryLimitationsV23Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdSetDeliveryLimitationsV23Q1.class);
  }

 /**
  * Convert an instance of AdSetDeliveryLimitationsV23Q1 to an JSON string
  *
  * @return JSON string
  */
