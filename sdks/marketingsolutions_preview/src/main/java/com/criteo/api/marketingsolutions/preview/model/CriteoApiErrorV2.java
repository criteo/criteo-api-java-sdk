 ...
 */
@ApiModel(description = "Criteo API response error")
...
public class CriteoApiErrorV2 {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "access-control", value = "A machine-readable code specifying error category")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(traceId, type, code, instance, title, detail, source);
  }
