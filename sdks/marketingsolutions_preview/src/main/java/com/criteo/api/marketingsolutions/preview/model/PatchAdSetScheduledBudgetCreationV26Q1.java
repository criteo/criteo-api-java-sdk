...
public class PatchAdSetScheduledBudgetCreationV26Q1 {
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1() {
  }

  public PatchAdSetScheduledBudgetCreationV26Q1 budgetAmount(Double budgetAmount) {
   ...
   /**
   * Maximum budget amount in the advertiser&#39;s currency per renewal period.  Required when budgetStrategy is \&quot;capped\&quot;; must be omitted when budgetStrategy is \&quot;uncapped\&quot;.
   * @return budgetAmount
  **/
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1 pacingBehavior(PacingBehaviorEnum pacingBehavior) {
  ...
  **/
  ...
  public PatchAdSetScheduledBudgetCreationV26Q1 startDate(LocalDate startDate) {
   ...
   /**
   * Advertiser-local calendar date when the scheduled budget becomes active. Required, strictly in the future.
   * @return startDate
  **/
   ...
   * @return the PatchAdSetScheduledBudgetCreationV26Q1 instance itself
   */
  public PatchAdSetScheduledBudgetCreationV26Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchAdSetScheduledBudgetCreationV26Q1 patchAdSetScheduledBudgetCreationV26Q1 = (PatchAdSetScheduledBudgetCreationV26Q1) o;
    return Objects.equals(this.budgetAmount, patchAdSetScheduledBudgetCreationV26Q1.budgetAmount) &&
        Objects.equals(this.budgetDeliverySmoothing, patchAdSetScheduledBudgetCreationV26Q1.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, patchAdSetScheduledBudgetCreationV26Q1.budgetDeliveryWeek) &&
        Objects.equals(this.budgetRenewal, patchAdSetScheduledBudgetCreationV26Q1.budgetRenewal) &&
        Objects.equals(this.budgetStrategy, patchAdSetScheduledBudgetCreationV26Q1.budgetStrategy) &&
        Objects.equals(this.pacingBehavior, patchAdSetScheduledBudgetCreationV26Q1.pacingBehavior) &&
        Objects.equals(this.startDate, patchAdSetScheduledBudgetCreationV26Q1.startDate)&&
        Objects.equals(this.additionalProperties, patchAdSetScheduledBudgetCreationV26Q1.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(budgetAmount, budgetDeliverySmoothing, budgetDeliveryWeek, budgetRenewal, budgetStrategy, pacingBehavior, startDate, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchAdSetScheduledBudgetCreationV26Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchAdSetScheduledBudgetCreationV26Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchAdSetScheduledBudgetCreationV26Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchAdSetScheduledBudgetCreationV26Q1 is not found in the empty JSON string", PatchAdSetScheduledBudgetCreationV26Q1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchAdSetScheduledBudgetCreationV26Q1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAdSetScheduledBudgetCreationV26Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAdSetScheduledBudgetCreationV26Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAdSetScheduledBudgetCreationV26Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAdSetScheduledBudgetCreationV26Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAdSetScheduledBudgetCreationV26Q1>() {
           @Override
           public void write(JsonWriter out, PatchAdSetScheduledBudgetCreationV26Q1 value) throws IOException {
           ...
           @Override
           public PatchAdSetScheduledBudgetCreationV26Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchAdSetScheduledBudgetCreationV26Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchAdSetScheduledBudgetCreationV26Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchAdSetScheduledBudgetCreationV26Q1
  * @throws IOException if the JSON string is invalid with respect to PatchAdSetScheduledBudgetCreationV26Q1
  */
  public static PatchAdSetScheduledBudgetCreationV26Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAdSetScheduledBudgetCreationV26Q1.class);
  }

 /**
  * Convert an instance of PatchAdSetScheduledBudgetCreationV26Q1 to an JSON string
  *
  * @return JSON string
  */
