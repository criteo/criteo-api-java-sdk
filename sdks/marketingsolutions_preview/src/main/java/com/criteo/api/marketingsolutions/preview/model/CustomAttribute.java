...
public class CustomAttribute {
  ...
  **/
   ...
   * @return the CustomAttribute instance itself
   */
  public CustomAttribute putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, customAttribute.name) &&
        ...
        Objects.equals(this.additionalProperties, customAttribute.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomAttribute
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomAttribute>() {
           ...
           public CustomAttribute read(JsonReader in) throws IOException {
             ...
             CustomAttribute instance = thisAdapter.fromJsonTree(jsonObj);
