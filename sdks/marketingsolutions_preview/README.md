...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:0.0.220624"
```
...
* `target/criteo-api-marketingsolutions-sdk-0.0.220624.jar`
* `target/lib/*.jar`
...
*RecoApi* | [**fetchProductSets**](docs/RecoApi.md#fetchProductSets) | **GET** /preview/product-sets/partner/{partner-id} | 
