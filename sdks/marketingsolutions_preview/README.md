...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:0.0.220926"
```
...
* `target/criteo-api-marketingsolutions-sdk-0.0.220926.jar`
* `target/lib/*.jar`
