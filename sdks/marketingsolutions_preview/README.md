...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:0.0.260420"
```
...
* `build/libs/criteo-api-marketingsolutions-sdk-0.0.260420.jar`
...
*AnalyticsApi* | [**createRealtimeProductReport**](docs/AnalyticsApi.md#createRealtimeProductReport) | **POST** /preview/marketing-solutions/marketplace-performance-outcomes/stats/realtime-reports/export | 
...
*AnalyticsApi* | [**getRealtimeProduct**](docs/AnalyticsApi.md#getRealtimeProduct) | **GET** /preview/marketing-solutions/marketplace-performance-outcomes/stats/realtime-reports/{reportId} | 
*AnalyticsApi* | [**getRealtimeProductJob**](docs/AnalyticsApi.md#getRealtimeProductJob) | **GET** /preview/marketing-solutions/marketplace-performance-outcomes/stats/report-jobs/{reportId} | 
...
*AudienceApi* | [**deleteAudiences**](docs/AudienceApi.md#deleteAudiences) | **POST** /preview/marketing-solutions/audiences/delete | 
*AudienceApi* | [**deleteContactListByAudienceSegment**](docs/AudienceApi.md#deleteContactListByAudienceSegment) | **DELETE** /preview/marketing-solutions/audience-segments/{audience-segment-id}/contact-list | 
...
*AudienceApi* | [**modifyAudienceUsersWithAttributes**](docs/AudienceApi.md#modifyAudienceUsersWithAttributes) | **PATCH** /preview/marketing-solutions/audiences/{audience-id}/contactlist-attributes | 
...
*AudienceApi* | [**updateContactListByAudienceSegment**](docs/AudienceApi.md#updateContactListByAudienceSegment) | **PATCH** /preview/marketing-solutions/audience-segments/{audience-segment-id}/contact-list | 
...
*CatalogApi* | [**getCatalogMerchantStats**](docs/CatalogApi.md#getCatalogMerchantStats) | **GET** /preview/catalog/stats/merchants/{merchant-id} | 
*CatalogApi* | [**getCatalogProductsBatchReport**](docs/CatalogApi.md#getCatalogProductsBatchReport) | **GET** /preview/catalog/products/batch/report/{operation-token} | 
*CatalogApi* | [**submitCatalogProductsBatch**](docs/CatalogApi.md#submitCatalogProductsBatch) | **POST** /preview/catalog/products/batch | 
...
*CreativeApi* | [**deleteAdSegmentLink**](docs/CreativeApi.md#deleteAdSegmentLink) | **DELETE** /preview/marketing-solutions/ads/{ad-id}/audience-segment | 
...
*CreativeApi* | [**getAdSegmentLink**](docs/CreativeApi.md#getAdSegmentLink) | **GET** /preview/marketing-solutions/ads/{ad-id}/audience-segment | 
...
*CreativeApi* | [**linkAdSegment**](docs/CreativeApi.md#linkAdSegment) | **PUT** /preview/marketing-solutions/ads/{ad-id}/audience-segment | 
...
*OnSiteRecommendationApi* | [**searchRecommendedProductsConversational**](docs/OnSiteRecommendationApi.md#searchRecommendedProductsConversational) | **POST** /preview/recommendation/search-conversational | 
*RecoApi* | [**createBoostedAdAssociation**](docs/RecoApi.md#createBoostedAdAssociation) | **POST** /preview/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} | 
*RecoApi* | [**createProductSet**](docs/RecoApi.md#createProductSet) | **POST** /preview/product-sets | 
*RecoApi* | [**deleteBoostedAdAssociation**](docs/RecoApi.md#deleteBoostedAdAssociation) | **DELETE** /preview/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} | 
...
*RecoApi* | [**fetchBoostedAdAssociation**](docs/RecoApi.md#fetchBoostedAdAssociation) | **GET** /preview/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} | 
*RecoApi* | [**fetchBoostedAdAssociationByPartnerId**](docs/RecoApi.md#fetchBoostedAdAssociationByPartnerId) | **GET** /preview/marketing-solutions/dataset/{dataset-id}/product-boost | 
*RecoApi* | [**fetchBoostedAdAssociations**](docs/RecoApi.md#fetchBoostedAdAssociations) | **GET** /preview/marketing-solutions/ads/{ad-id}/product-boost | 
