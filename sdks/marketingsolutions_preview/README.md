...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:0.0.220520"
```
...
* `target/criteo-api-marketingsolutions-sdk-0.0.220520.jar`
* `target/lib/*.jar`
