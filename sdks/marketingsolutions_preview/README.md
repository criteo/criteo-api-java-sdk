...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:0.0.221229"
```
...
* `target/criteo-api-marketingsolutions-sdk-0.0.221229.jar`
* `target/lib/*.jar`
