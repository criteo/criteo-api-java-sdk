...
import com.criteo.api.retailmedia.v2025_07.model.ValueResourceOfSellerCatalogRequestV2;
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ValueResourceInputOfSellerCatalogRequestV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValueResourceInputOfSellerCatalogRequestV2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
