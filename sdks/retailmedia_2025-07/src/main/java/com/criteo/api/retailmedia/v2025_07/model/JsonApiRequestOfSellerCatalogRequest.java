...
import com.criteo.api.retailmedia.v2025_07.model.JsonApiBodyWithoutIdOfSellerCatalogRequestAndSellerCatalogRequest;
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!JsonApiRequestOfSellerCatalogRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonApiRequestOfSellerCatalogRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
