...
import com.criteo.api.retailmedia.v2025_07.model.JsonApiBodyWithIdOfInt64AndRetailerAndRetailer;
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!JsonApiPageResponseOfRetailer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonApiPageResponseOfRetailer` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
