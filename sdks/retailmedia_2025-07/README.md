...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2025.07.0.260129"
```
...
* `build/libs/criteo-api-retailmedia-sdk-2025.07.0.260129.jar`
...
*AudienceApi* | [**addRemoveContactListByAudienceSegment**](docs/AudienceApi.md#addRemoveContactListByAudienceSegment) | **POST** /2025-07/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove | 
...
*AudienceApi* | [**clearContactListByAudienceSegment**](docs/AudienceApi.md#clearContactListByAudienceSegment) | **POST** /2025-07/retail-media/audience-segments/{audience-segment-id}/contact-list/clear | 
...
*CampaignApi* | [**createBrandCatalogExport**](docs/CampaignApi.md#createBrandCatalogExport) | **POST** /2025-07/retail-media/accounts/{accountId}/brand-catalog-export | 
...
*CampaignApi* | [**createSellerCatalogExport**](docs/CampaignApi.md#createSellerCatalogExport) | **POST** /2025-07/retail-media/accounts/{accountId}/seller-catalog-export | 
...
*CampaignApi* | [**deleteStoreTargetByLineItemId**](docs/CampaignApi.md#deleteStoreTargetByLineItemId) | **POST** /2025-07/retail-media/preferred-line-items/{line-item-id}/targeting/stores/delete | 
...
*CampaignApi* | [**getApiExternalV1Categories**](docs/CampaignApi.md#getApiExternalV1Categories) | **GET** /2025-07/retail-media/categories | 
...
*CampaignApi* | [**getCatalogOutput**](docs/CampaignApi.md#getCatalogOutput) | **GET** /2025-07/retail-media/catalogs/{catalogId}/output | 
*CampaignApi* | [**getCatalogStatus**](docs/CampaignApi.md#getCatalogStatus) | **GET** /2025-07/retail-media/catalogs/{catalogId}/status | 
...
*CampaignApi* | [**getKeywordInReviewReport**](docs/CampaignApi.md#getKeywordInReviewReport) | **GET** /2025-07/retail-media/accounts/{account-id}/keywords/in-review-report | 
...
*CampaignApi* | [**modifyAuctionLineItemsByCampaignId**](docs/CampaignApi.md#modifyAuctionLineItemsByCampaignId) | **POST** /2025-07/retail-media/campaigns/{campaign-id}/auction-line-items | 
...
*CampaignApi* | [**postApiExternalV1AccountCatalogsSellersByAccountId**](docs/CampaignApi.md#postApiExternalV1AccountCatalogsSellersByAccountId) | **POST** /2025-07/retail-media/accounts/{accountId}/catalogs/sellers | 
...
*CampaignApi* | [**updateKeywordReviews**](docs/CampaignApi.md#updateKeywordReviews) | **POST** /2025-07/retail-media/line-items/{line-item-id}/keywords/review | 
