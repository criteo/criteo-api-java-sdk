...
import com.criteo.api.marketingsolutions.v2024_04.model.Size;
...
public class Tag {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(htmlTag, size, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("htmlTag") != null && !jsonObj.get("htmlTag").isJsonNull()) && !jsonObj.get("htmlTag").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `htmlTag` to be a primitive type in the JSON string but got `%s`", jsonObj.get("htmlTag").toString()));
      }
      // validate the optional field `size`
      if (jsonObj.get("size") != null && !jsonObj.get("size").isJsonNull()) {
        Size.validateJsonObject(jsonObj.getAsJsonObject("size"));
      }
  }
