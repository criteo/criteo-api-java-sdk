...
public class RetargetingCreateV1 {
  ...
  **/
  ...
  public RetargetingCreateV1 daysSinceLastVisitMin(Integer daysSinceLastVisitMin) {
  ...
  **/
   ...
   * @return the RetargetingCreateV1 instance itself
   */
  public RetargetingCreateV1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RetargetingCreateV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RetargetingCreateV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetargetingCreateV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetargetingCreateV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetargetingCreateV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetargetingCreateV1.class));

       return (TypeAdapter<T>) new TypeAdapter<RetargetingCreateV1>() {
           @Override
           public void write(JsonWriter out, RetargetingCreateV1 value) throws IOException {
           ...
           @Override
           public RetargetingCreateV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RetargetingCreateV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RetargetingCreateV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RetargetingCreateV1
  * @throws IOException if the JSON string is invalid with respect to RetargetingCreateV1
  */
  public static RetargetingCreateV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetargetingCreateV1.class);
  }

 /**
  * Convert an instance of RetargetingCreateV1 to an JSON string
  *
  * @return JSON string
  */
