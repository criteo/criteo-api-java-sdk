...
public class AdSetTargetingRule {
  ...
  **/
   ...
   * @return the AdSetTargetingRule instance itself
   */
  public AdSetTargetingRule putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdSetTargetingRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdSetTargetingRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdSetTargetingRule is not found in the empty JSON string", AdSetTargetingRule.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdSetTargetingRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdSetTargetingRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdSetTargetingRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdSetTargetingRule.class));

       return (TypeAdapter<T>) new TypeAdapter<AdSetTargetingRule>() {
           @Override
           public void write(JsonWriter out, AdSetTargetingRule value) throws IOException {
           ...
           @Override
           public AdSetTargetingRule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AdSetTargetingRule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AdSetTargetingRule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AdSetTargetingRule
  * @throws IOException if the JSON string is invalid with respect to AdSetTargetingRule
  */
  public static AdSetTargetingRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdSetTargetingRule.class);
  }

 /**
  * Convert an instance of AdSetTargetingRule to an JSON string
  *
  * @return JSON string
  */
