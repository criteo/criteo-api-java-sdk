...
import com.criteo.api.marketingsolutions.v2024_04.model.AudienceSegmentEntityV1Resource;
import com.criteo.api.marketingsolutions.v2024_04.model.AudienceSegmentSearchMetadataV1;
...
public class AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse {
  ...
  **/
   ...
   * @return the AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse instance itself
   */
  public AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse>() {
           @Override
           public void write(JsonWriter out, AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse value) throws IOException {
           ...
           @Override
           public AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse
  ...
  */
  public static AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse.class);
  }

 /**
  * Convert an instance of AudienceSegmentEntityV1AudienceSegmentSearchMetadataV1ListResponse to an JSON string
  *
  * @return JSON string
  */
