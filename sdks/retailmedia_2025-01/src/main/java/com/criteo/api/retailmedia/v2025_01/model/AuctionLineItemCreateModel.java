...
public class AuctionLineItemCreateModel {
  /**
  ...
  public AuctionLineItemCreateModel() {
  }

  public AuctionLineItemCreateModel bidStrategy(BidStrategyEnum bidStrategy) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel budget(Double budget) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel dailyPacing(Double dailyPacing) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel endDate(LocalDate endDate) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel isAutoDailyPacing(Boolean isAutoDailyPacing) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel maxBid(Double maxBid) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel monthlyPacing(Double monthlyPacing) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel name(String name) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel startDate(LocalDate startDate) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel status(StatusEnum status) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel targetBid(Double targetBid) {
  ...
  **/
  ...
  public AuctionLineItemCreateModel targetRetailerId(String targetRetailerId) {
  ...
  **/
   ...
   * @return the AuctionLineItemCreateModel instance itself
   */
  public AuctionLineItemCreateModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuctionLineItemCreateModel auctionLineItemCreateModel = (AuctionLineItemCreateModel) o;
    return Objects.equals(this.bidStrategy, auctionLineItemCreateModel.bidStrategy) &&
        Objects.equals(this.budget, auctionLineItemCreateModel.budget) &&
        Objects.equals(this.dailyPacing, auctionLineItemCreateModel.dailyPacing) &&
        Objects.equals(this.endDate, auctionLineItemCreateModel.endDate) &&
        Objects.equals(this.isAutoDailyPacing, auctionLineItemCreateModel.isAutoDailyPacing) &&
        Objects.equals(this.maxBid, auctionLineItemCreateModel.maxBid) &&
        Objects.equals(this.monthlyPacing, auctionLineItemCreateModel.monthlyPacing) &&
        Objects.equals(this.name, auctionLineItemCreateModel.name) &&
        Objects.equals(this.startDate, auctionLineItemCreateModel.startDate) &&
        Objects.equals(this.status, auctionLineItemCreateModel.status) &&
        Objects.equals(this.targetBid, auctionLineItemCreateModel.targetBid) &&
        Objects.equals(this.targetRetailerId, auctionLineItemCreateModel.targetRetailerId)&&
        Objects.equals(this.additionalProperties, auctionLineItemCreateModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuctionLineItemCreateModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuctionLineItemCreateModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AuctionLineItemCreateModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuctionLineItemCreateModel is not found in the empty JSON string", AuctionLineItemCreateModel.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuctionLineItemCreateModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuctionLineItemCreateModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuctionLineItemCreateModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuctionLineItemCreateModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuctionLineItemCreateModel.class));

       return (TypeAdapter<T>) new TypeAdapter<AuctionLineItemCreateModel>() {
           @Override
           public void write(JsonWriter out, AuctionLineItemCreateModel value) throws IOException {
           ...
           @Override
           public AuctionLineItemCreateModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AuctionLineItemCreateModel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AuctionLineItemCreateModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuctionLineItemCreateModel
  * @throws IOException if the JSON string is invalid with respect to AuctionLineItemCreateModel
  */
  public static AuctionLineItemCreateModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuctionLineItemCreateModel.class);
  }

 /**
  * Convert an instance of AuctionLineItemCreateModel to an JSON string
  *
  * @return JSON string
  */
