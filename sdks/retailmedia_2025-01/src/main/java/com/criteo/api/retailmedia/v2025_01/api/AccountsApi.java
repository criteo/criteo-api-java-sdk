...
import com.criteo.api.retailmedia.v2025_01.model.EntityResourceOutcomeOfRetailMediaAccount;
import com.criteo.api.retailmedia.v2025_01.model.GrantConsentInput;
import com.criteo.api.retailmedia.v2025_01.model.JsonApiPageResponseOfAccount;
import com.criteo.api.retailmedia.v2025_01.model.ValueResourceCollectionInputOfRetailMediaSeller;
import com.criteo.api.retailmedia.v2025_01.model.ValueResourceCollectionOutcomeOfRetailMediaSeller;
import com.criteo.api.retailmedia.v2025_01.model.ValueResourceInputOfRetailMediaBrandAccountCreation;
import com.criteo.api.retailmedia.v2025_01.model.ValueResourceInputOfRetailMediaBrands;
import com.criteo.api.retailmedia.v2025_01.model.ValueResourceInputOfRetailMediaSellerAccountCreation;
import com.criteo.api.retailmedia.v2025_01.model.ValueResourceOutcomeOfRetailMediaBrands;
...
public class AccountsApi {
    ...
    public okhttp3.Call addBrandsCall(String accountId, ValueResourceInputOfRetailMediaBrands valueResourceInputOfRetailMediaBrands, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2025-01/retail-media/account-management/accounts/{accountId}/brands/add"
    ...
    public okhttp3.Call createPrivateMarketDemandBrandAccountCall(String accountId, ValueResourceInputOfRetailMediaBrandAccountCreation valueResourceInputOfRetailMediaBrandAccountCreation, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/retail-media/account-management/accounts/{accountId}/create-brand-account"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call createPrivateMarketDemandSellerAccountCall(String accountId, ValueResourceInputOfRetailMediaSellerAccountCreation valueResourceInputOfRetailMediaSellerAccountCreation, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/retail-media/account-management/accounts/{accountId}/create-seller-account"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call getApiV1ExternalAccountsCall(List<String> limitToId, Integer pageIndex, Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/retail-media/accounts";
    ...
    public okhttp3.Call grantConsentCall(String accountId, GrantConsentInput grantConsentInput, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/retail-media/accounts/{accountId}/grant-consent"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call removeBrandsCall(String accountId, ValueResourceInputOfRetailMediaBrands valueResourceInputOfRetailMediaBrands, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/retail-media/account-management/accounts/{accountId}/brands/remove"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call updateSellersCall(String accountId, ValueResourceCollectionInputOfRetailMediaSeller valueResourceCollectionInputOfRetailMediaSeller, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/retail-media/account-management/accounts/{accountId}/sellers"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
