...
<dependency>
    ...
    <version>2023.01.0.230411</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230411"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230411.jar`
* `target/lib/*.jar`
