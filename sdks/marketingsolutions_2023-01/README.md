...
<dependency>
    ...
    <version>2023.01.0.230224</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230224"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230224.jar`
* `target/lib/*.jar`
