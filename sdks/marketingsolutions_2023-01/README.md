...
- Package version: 2023.01.0.230323
...
<dependency>
    ...
    <version>2023.01.0.230323</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230323"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230323.jar`
* `target/lib/*.jar`
