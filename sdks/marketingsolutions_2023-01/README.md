...
- Package version: 2023.01.0.230728
...
<dependency>
    ...
    <version>2023.01.0.230728</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230728"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230728.jar`
* `target/lib/*.jar`
