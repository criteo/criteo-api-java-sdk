...
- Package version: 2023.01.0.230331
...
<dependency>
    ...
    <version>2023.01.0.230331</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230331"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230331.jar`
* `target/lib/*.jar`
