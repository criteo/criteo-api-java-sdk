...
- Package version: 2023.01.0.230324
...
<dependency>
    ...
    <version>2023.01.0.230324</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230324"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230324.jar`
* `target/lib/*.jar`
