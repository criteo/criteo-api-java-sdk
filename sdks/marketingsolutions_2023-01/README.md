...
- Package version: 2023.01.0.230831
...
<dependency>
    ...
    <version>2023.01.0.230831</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230831"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230831.jar`
* `target/lib/*.jar`
