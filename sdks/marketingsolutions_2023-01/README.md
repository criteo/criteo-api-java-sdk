...
<dependency>
    ...
    <version>2023.01.0.230427</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230427"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230427.jar`
* `target/lib/*.jar`
