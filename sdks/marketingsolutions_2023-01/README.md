...
- Package version: 2023.01.0.230601
...
<dependency>
    ...
    <version>2023.01.0.230601</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2023.01.0.230601"
```
...
* `target/criteo-api-marketingsolutions-sdk-2023.01.0.230601.jar`
* `target/lib/*.jar`
