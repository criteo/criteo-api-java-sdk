...
public class AccessTokenModel {
  ...
  **/
   ...
   * @return the AccessTokenModel instance itself
   */
  public AccessTokenModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, accessTokenModel.accessToken) &&
        ...
        Objects.equals(this.additionalProperties, accessTokenModel.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccessTokenModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccessTokenModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessTokenModel is not found in the empty JSON string", AccessTokenModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessTokenModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessTokenModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessTokenModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessTokenModel.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessTokenModel>() {
           @Override
           public void write(JsonWriter out, AccessTokenModel value) throws IOException {
           ...
           @Override
           public AccessTokenModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccessTokenModel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccessTokenModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccessTokenModel
  * @throws IOException if the JSON string is invalid with respect to AccessTokenModel
  */
  public static AccessTokenModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessTokenModel.class);
  }

 /**
  * Convert an instance of AccessTokenModel to an JSON string
  *
  * @return JSON string
  */
