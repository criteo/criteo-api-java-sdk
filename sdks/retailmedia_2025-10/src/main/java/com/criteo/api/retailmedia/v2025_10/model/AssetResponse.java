...
import com.criteo.api.retailmedia.v2025_10.model.AssetResource;
...
public class AssetResponse {
  ...
  public AssetResponse data(AssetResource data) {
  ...
  **/
  ...
  public AssetResource getData() {
    return data;
  }


  public void setData(AssetResource data) {
    this.data = data;
  }
  ...
  **/
   ...
   * @return the AssetResponse instance itself
   */
  public AssetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, assetResponse.data) &&
        Objects.equals(this.errors, assetResponse.errors) &&
        Objects.equals(this.warnings, assetResponse.warnings)&&
        Objects.equals(this.additionalProperties, assetResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        AssetResource.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AssetResponse>() {
           ...
           public AssetResponse read(JsonReader in) throws IOException {
             ...
             AssetResponse instance = thisAdapter.fromJsonTree(jsonObj);
