...
public class RmContactListV1 {
  ...
  **/
   ...
   * @return the RmContactListV1 instance itself
   */
  public RmContactListV1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RmContactListV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RmContactListV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmContactListV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmContactListV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmContactListV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmContactListV1.class));

       return (TypeAdapter<T>) new TypeAdapter<RmContactListV1>() {
           @Override
           public void write(JsonWriter out, RmContactListV1 value) throws IOException {
           ...
           @Override
           public RmContactListV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RmContactListV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RmContactListV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RmContactListV1
  * @throws IOException if the JSON string is invalid with respect to RmContactListV1
  */
  public static RmContactListV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmContactListV1.class);
  }

 /**
  * Convert an instance of RmContactListV1 to an JSON string
  *
  * @return JSON string
  */
