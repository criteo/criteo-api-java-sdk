 ...
 */
@ApiModel(description = "Model to create a retail media auction line item")
...
public class ExternalAuctionLineItemCreateModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, startDate, endDate, status, targetRetailerId, budget, targetBid, maxBid, monthlyPacing, dailyPacing, isAutoDailyPacing, bidStrategy);
  }
