...
import com.criteo.api.marketingsolutions.v2024_07.model.CreateCampaignResource;
...
public class CreateCampaignRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCampaignRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCampaignRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CreateCampaignResource.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
  }
