...
import com.criteo.api.marketingsolutions.v2024_07.model.CreateAdSetBiddingV24Q1;
import com.criteo.api.marketingsolutions.v2024_07.model.CreateAdSetBudgetV24Q1;
import com.criteo.api.marketingsolutions.v2024_07.model.CreateAdSetScheduleV24Q1;
import com.criteo.api.marketingsolutions.v2024_07.model.CreateAdSetTargetingV24Q1;
...
public class CreateAdSetV24Q1 {
  ...
  **/
  ...
  public CreateAdSetBiddingV24Q1 getBidding() {
    return bidding;
  }


  public void setBidding(CreateAdSetBiddingV24Q1 bidding) {
    this.bidding = bidding;
  }


  public CreateAdSetV24Q1 budget(CreateAdSetBudgetV24Q1 budget) {
  ...
  **/
  ...
  public void setBudget(CreateAdSetBudgetV24Q1 budget) {
    this.budget = budget;
  }


  public CreateAdSetV24Q1 campaignId(String campaignId) {
  ...
  **/
  ...
  public CreateAdSetV24Q1 datasetId(String datasetId) {
  ...
  **/
  ...
  public CreateAdSetV24Q1 mediaType(MediaTypeEnum mediaType) {
  ...
  **/
  ...
  public CreateAdSetV24Q1 name(String name) {
  ...
  **/
  ...
  public CreateAdSetV24Q1 objective(ObjectiveEnum objective) {
  ...
  **/
  ...
  public CreateAdSetV24Q1 schedule(CreateAdSetScheduleV24Q1 schedule) {
  ...
  **/
  ...
  public CreateAdSetScheduleV24Q1 getSchedule() {
    return schedule;
  }


  public void setSchedule(CreateAdSetScheduleV24Q1 schedule) {
    this.schedule = schedule;
  }


  public CreateAdSetV24Q1 targeting(CreateAdSetTargetingV24Q1 targeting) {
  ...
  **/
  ...
  public CreateAdSetTargetingV24Q1 getTargeting() {
    return targeting;
  }


  public void setTargeting(CreateAdSetTargetingV24Q1 targeting) {
    this.targeting = targeting;
  }


  public CreateAdSetV24Q1 trackingCode(String trackingCode) {
  ...
  **/
   ...
   * @return the CreateAdSetV24Q1 instance itself
   */
  public CreateAdSetV24Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAdSetV24Q1 createAdSetV24Q1 = (CreateAdSetV24Q1) o;
    return Objects.equals(this.bidding, createAdSetV24Q1.bidding) &&
        Objects.equals(this.budget, createAdSetV24Q1.budget) &&
        Objects.equals(this.campaignId, createAdSetV24Q1.campaignId) &&
        Objects.equals(this.datasetId, createAdSetV24Q1.datasetId) &&
        Objects.equals(this.mediaType, createAdSetV24Q1.mediaType) &&
        Objects.equals(this.name, createAdSetV24Q1.name) &&
        Objects.equals(this.objective, createAdSetV24Q1.objective) &&
        Objects.equals(this.schedule, createAdSetV24Q1.schedule) &&
        Objects.equals(this.targeting, createAdSetV24Q1.targeting) &&
        Objects.equals(this.trackingCode, createAdSetV24Q1.trackingCode)&&
        Objects.equals(this.additionalProperties, createAdSetV24Q1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAdSetV24Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAdSetV24Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateAdSetV24Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAdSetV24Q1 is not found in the empty JSON string", CreateAdSetV24Q1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAdSetV24Q1.openapiRequiredFields) {
      ...
      CreateAdSetScheduleV24Q1.validateJsonObject(jsonObj.getAsJsonObject("schedule"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAdSetV24Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAdSetV24Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAdSetV24Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAdSetV24Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAdSetV24Q1>() {
           @Override
           public void write(JsonWriter out, CreateAdSetV24Q1 value) throws IOException {
           ...
           @Override
           public CreateAdSetV24Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateAdSetV24Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateAdSetV24Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAdSetV24Q1
  * @throws IOException if the JSON string is invalid with respect to CreateAdSetV24Q1
  */
  public static CreateAdSetV24Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAdSetV24Q1.class);
  }

 /**
  * Convert an instance of CreateAdSetV24Q1 to an JSON string
  *
  * @return JSON string
  */
