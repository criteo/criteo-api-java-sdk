...
public class ReadAdSetScheduleV24Q1 {
  ...
  **/
  ...
  public ReadAdSetScheduleV24Q1 deliveryStatus(DeliveryStatusEnum deliveryStatus) {
  ...
  **/
   ...
   * @return the ReadAdSetScheduleV24Q1 instance itself
   */
  public ReadAdSetScheduleV24Q1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadAdSetScheduleV24Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadAdSetScheduleV24Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadAdSetScheduleV24Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadAdSetScheduleV24Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadAdSetScheduleV24Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadAdSetScheduleV24Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadAdSetScheduleV24Q1>() {
           @Override
           public void write(JsonWriter out, ReadAdSetScheduleV24Q1 value) throws IOException {
           ...
           @Override
           public ReadAdSetScheduleV24Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReadAdSetScheduleV24Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReadAdSetScheduleV24Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadAdSetScheduleV24Q1
  * @throws IOException if the JSON string is invalid with respect to ReadAdSetScheduleV24Q1
  */
  public static ReadAdSetScheduleV24Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadAdSetScheduleV24Q1.class);
  }

 /**
  * Convert an instance of ReadAdSetScheduleV24Q1 to an JSON string
  *
  * @return JSON string
  */
