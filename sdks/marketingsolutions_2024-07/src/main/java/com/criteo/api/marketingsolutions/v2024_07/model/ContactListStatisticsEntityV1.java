...
public class ContactListStatisticsEntityV1 {
  ...
  **/
   ...
   * @return the ContactListStatisticsEntityV1 instance itself
   */
  public ContactListStatisticsEntityV1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactListStatisticsEntityV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContactListStatisticsEntityV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactListStatisticsEntityV1 is not found in the empty JSON string", ContactListStatisticsEntityV1.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactListStatisticsEntityV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactListStatisticsEntityV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactListStatisticsEntityV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactListStatisticsEntityV1.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactListStatisticsEntityV1>() {
           @Override
           public void write(JsonWriter out, ContactListStatisticsEntityV1 value) throws IOException {
           ...
           @Override
           public ContactListStatisticsEntityV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContactListStatisticsEntityV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContactListStatisticsEntityV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContactListStatisticsEntityV1
  * @throws IOException if the JSON string is invalid with respect to ContactListStatisticsEntityV1
  */
  public static ContactListStatisticsEntityV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactListStatisticsEntityV1.class);
  }

 /**
  * Convert an instance of ContactListStatisticsEntityV1 to an JSON string
  *
  * @return JSON string
  */
