...
<dependency>
  ...
  <artifactId>criteo-api-petstore-sdk-java8</artifactId>
  <version></version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-petstore-sdk-java8:"
```
...
* `target/criteo-api-petstore-sdk-java8-.jar`
* `target/lib/*.jar`
...
------------ | ------------- | ------------- | -------------
*PetApi* | [**addPet**](docs/PetApi.md#addPet) | **POST** /pet-test | Add a new pet to the store
