...
import com.criteo.api.retailmedia.v2024_01.model.RmLegacySegmentCustomerList;
import com.criteo.api.retailmedia.v2024_01.model.RmLegacySegmentUserBehaviorV1;
...
public class RmLegacyAudienceGetEntityV1 {
  ...
  **/
  ...
  public RmLegacyAudienceGetEntityV1 retailerId(String retailerId) {
  ...
  **/
  ...
  public RmLegacyAudienceGetEntityV1 userBehaviorDetails(RmLegacySegmentUserBehaviorV1 userBehaviorDetails) {
  ...
  **/
  ...
  public RmLegacySegmentUserBehaviorV1 getUserBehaviorDetails() {
    return userBehaviorDetails;
  }


  public void setUserBehaviorDetails(RmLegacySegmentUserBehaviorV1 userBehaviorDetails) {
    this.userBehaviorDetails = userBehaviorDetails;
  }
  ...
  **/
   ...
   * @return the RmLegacyAudienceGetEntityV1 instance itself
   */
  public RmLegacyAudienceGetEntityV1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RmLegacyAudienceGetEntityV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RmLegacyAudienceGetEntityV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmLegacyAudienceGetEntityV1 is not found in the empty JSON string", RmLegacyAudienceGetEntityV1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RmLegacyAudienceGetEntityV1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmLegacyAudienceGetEntityV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmLegacyAudienceGetEntityV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmLegacyAudienceGetEntityV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmLegacyAudienceGetEntityV1.class));

       return (TypeAdapter<T>) new TypeAdapter<RmLegacyAudienceGetEntityV1>() {
           @Override
           public void write(JsonWriter out, RmLegacyAudienceGetEntityV1 value) throws IOException {
           ...
           @Override
           public RmLegacyAudienceGetEntityV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RmLegacyAudienceGetEntityV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RmLegacyAudienceGetEntityV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RmLegacyAudienceGetEntityV1
  * @throws IOException if the JSON string is invalid with respect to RmLegacyAudienceGetEntityV1
  */
  public static RmLegacyAudienceGetEntityV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmLegacyAudienceGetEntityV1.class);
  }

 /**
  * Convert an instance of RmLegacyAudienceGetEntityV1 to an JSON string
  *
  * @return JSON string
  */
