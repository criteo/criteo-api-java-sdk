...
public class AdSetDeliveryLimitationsV24Q3 {
  /**
  ...
  public AdSetDeliveryLimitationsV24Q3() {
  }

  public AdSetDeliveryLimitationsV24Q3 devices(List<DevicesEnum> devices) {
    
    this.devices = devices;
    return this;
  }

  public AdSetDeliveryLimitationsV24Q3 addDevicesItem(DevicesEnum devicesItem) {
  ...
  **/
  ...
  public AdSetDeliveryLimitationsV24Q3 environments(List<EnvironmentsEnum> environments) {
    
    this.environments = environments;
    return this;
  }

  public AdSetDeliveryLimitationsV24Q3 addEnvironmentsItem(EnvironmentsEnum environmentsItem) {
  ...
  **/
  ...
  public AdSetDeliveryLimitationsV24Q3 operatingSystems(List<OperatingSystemsEnum> operatingSystems) {
    
    this.operatingSystems = operatingSystems;
    return this;
  }

  public AdSetDeliveryLimitationsV24Q3 addOperatingSystemsItem(OperatingSystemsEnum operatingSystemsItem) {
  ...
  **/
   ...
   * @return the AdSetDeliveryLimitationsV24Q3 instance itself
   */
  public AdSetDeliveryLimitationsV24Q3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AdSetDeliveryLimitationsV24Q3 adSetDeliveryLimitationsV24Q3 = (AdSetDeliveryLimitationsV24Q3) o;
    return Objects.equals(this.devices, adSetDeliveryLimitationsV24Q3.devices) &&
        Objects.equals(this.environments, adSetDeliveryLimitationsV24Q3.environments) &&
        Objects.equals(this.operatingSystems, adSetDeliveryLimitationsV24Q3.operatingSystems)&&
        Objects.equals(this.additionalProperties, adSetDeliveryLimitationsV24Q3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdSetDeliveryLimitationsV24Q3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdSetDeliveryLimitationsV24Q3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdSetDeliveryLimitationsV24Q3 is not found in the empty JSON string", AdSetDeliveryLimitationsV24Q3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdSetDeliveryLimitationsV24Q3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdSetDeliveryLimitationsV24Q3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdSetDeliveryLimitationsV24Q3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdSetDeliveryLimitationsV24Q3.class));

       return (TypeAdapter<T>) new TypeAdapter<AdSetDeliveryLimitationsV24Q3>() {
           @Override
           public void write(JsonWriter out, AdSetDeliveryLimitationsV24Q3 value) throws IOException {
           ...
           @Override
           public AdSetDeliveryLimitationsV24Q3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AdSetDeliveryLimitationsV24Q3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AdSetDeliveryLimitationsV24Q3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AdSetDeliveryLimitationsV24Q3
  * @throws IOException if the JSON string is invalid with respect to AdSetDeliveryLimitationsV24Q3
  */
  public static AdSetDeliveryLimitationsV24Q3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdSetDeliveryLimitationsV24Q3.class);
  }

 /**
  * Convert an instance of AdSetDeliveryLimitationsV24Q3 to an JSON string
  *
  * @return JSON string
  */
