...
public class CouponSupportedSizes {
  ...
  **/
   ...
   * @return the CouponSupportedSizes instance itself
   */
  public CouponSupportedSizes putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CouponSupportedSizes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CouponSupportedSizes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CouponSupportedSizes is not found in the empty JSON string", CouponSupportedSizes.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CouponSupportedSizes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CouponSupportedSizes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CouponSupportedSizes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CouponSupportedSizes.class));

       return (TypeAdapter<T>) new TypeAdapter<CouponSupportedSizes>() {
           @Override
           public void write(JsonWriter out, CouponSupportedSizes value) throws IOException {
           ...
           @Override
           public CouponSupportedSizes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CouponSupportedSizes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CouponSupportedSizes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CouponSupportedSizes
  * @throws IOException if the JSON string is invalid with respect to CouponSupportedSizes
  */
  public static CouponSupportedSizes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CouponSupportedSizes.class);
  }

 /**
  * Convert an instance of CouponSupportedSizes to an JSON string
  *
  * @return JSON string
  */
