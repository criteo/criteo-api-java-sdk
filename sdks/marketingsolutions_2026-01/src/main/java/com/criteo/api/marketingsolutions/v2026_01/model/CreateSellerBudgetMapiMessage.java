...
public class CreateSellerBudgetMapiMessage {
  ...
  public CreateSellerBudgetMapiMessage() {
  }
  ...
  **/
   ...
   * @return the CreateSellerBudgetMapiMessage instance itself
   */
  public CreateSellerBudgetMapiMessage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, createSellerBudgetMapiMessage.amount) &&
        ...
        Objects.equals(this.additionalProperties, createSellerBudgetMapiMessage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, budgetType, campaignIds, endDate, sellerId, startDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSellerBudgetMapiMessage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSellerBudgetMapiMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSellerBudgetMapiMessage is not found in the empty JSON string", CreateSellerBudgetMapiMessage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSellerBudgetMapiMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSellerBudgetMapiMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSellerBudgetMapiMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSellerBudgetMapiMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSellerBudgetMapiMessage>() {
           @Override
           public void write(JsonWriter out, CreateSellerBudgetMapiMessage value) throws IOException {
           ...
           @Override
           public CreateSellerBudgetMapiMessage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateSellerBudgetMapiMessage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateSellerBudgetMapiMessage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSellerBudgetMapiMessage
  * @throws IOException if the JSON string is invalid with respect to CreateSellerBudgetMapiMessage
  */
  public static CreateSellerBudgetMapiMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSellerBudgetMapiMessage.class);
  }

 /**
  * Convert an instance of CreateSellerBudgetMapiMessage to an JSON string
  *
  * @return JSON string
  */
