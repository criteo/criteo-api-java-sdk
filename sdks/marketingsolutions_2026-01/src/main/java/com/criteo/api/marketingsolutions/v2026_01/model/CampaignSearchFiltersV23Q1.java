...
public class CampaignSearchFiltersV23Q1 {
  ...
  public CampaignSearchFiltersV23Q1 addAdvertiserIdsItem(String advertiserIdsItem) {
  ...
  **/
   ...
   * @return the CampaignSearchFiltersV23Q1 instance itself
   */
  public CampaignSearchFiltersV23Q1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignSearchFiltersV23Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignSearchFiltersV23Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignSearchFiltersV23Q1 is not found in the empty JSON string", CampaignSearchFiltersV23Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignSearchFiltersV23Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignSearchFiltersV23Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignSearchFiltersV23Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignSearchFiltersV23Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignSearchFiltersV23Q1>() {
           @Override
           public void write(JsonWriter out, CampaignSearchFiltersV23Q1 value) throws IOException {
           ...
           @Override
           public CampaignSearchFiltersV23Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignSearchFiltersV23Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignSearchFiltersV23Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignSearchFiltersV23Q1
  * @throws IOException if the JSON string is invalid with respect to CampaignSearchFiltersV23Q1
  */
  public static CampaignSearchFiltersV23Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignSearchFiltersV23Q1.class);
  }

 /**
  * Convert an instance of CampaignSearchFiltersV23Q1 to an JSON string
  *
  * @return JSON string
  */
