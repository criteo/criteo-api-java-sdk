...
public class AdSetDeliveryLimitationsV24Q1 {
  ...
  public AdSetDeliveryLimitationsV24Q1 addDevicesItem(DevicesEnum devicesItem) {
  ...
  **/
  ...
  public AdSetDeliveryLimitationsV24Q1 operatingSystems(List<OperatingSystemsEnum> operatingSystems) {
    
    this.operatingSystems = operatingSystems;
    return this;
  }

  public AdSetDeliveryLimitationsV24Q1 addOperatingSystemsItem(OperatingSystemsEnum operatingSystemsItem) {
  ...
  **/
   ...
   * @return the AdSetDeliveryLimitationsV24Q1 instance itself
   */
  public AdSetDeliveryLimitationsV24Q1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdSetDeliveryLimitationsV24Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdSetDeliveryLimitationsV24Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdSetDeliveryLimitationsV24Q1 is not found in the empty JSON string", AdSetDeliveryLimitationsV24Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdSetDeliveryLimitationsV24Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdSetDeliveryLimitationsV24Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdSetDeliveryLimitationsV24Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdSetDeliveryLimitationsV24Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<AdSetDeliveryLimitationsV24Q1>() {
           @Override
           public void write(JsonWriter out, AdSetDeliveryLimitationsV24Q1 value) throws IOException {
           ...
           @Override
           public AdSetDeliveryLimitationsV24Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AdSetDeliveryLimitationsV24Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AdSetDeliveryLimitationsV24Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AdSetDeliveryLimitationsV24Q1
  * @throws IOException if the JSON string is invalid with respect to AdSetDeliveryLimitationsV24Q1
  */
  public static AdSetDeliveryLimitationsV24Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdSetDeliveryLimitationsV24Q1.class);
  }

 /**
  * Convert an instance of AdSetDeliveryLimitationsV24Q1 to an JSON string
  *
  * @return JSON string
  */
