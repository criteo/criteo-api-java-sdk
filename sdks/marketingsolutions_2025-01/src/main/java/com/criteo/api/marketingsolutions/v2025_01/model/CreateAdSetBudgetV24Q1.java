...
public class CreateAdSetBudgetV24Q1 {
  /**
  ...
  public CreateAdSetBudgetV24Q1() {
  }

  public CreateAdSetBudgetV24Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
  ...
  public CreateAdSetBudgetV24Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public CreateAdSetBudgetV24Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public CreateAdSetBudgetV24Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public CreateAdSetBudgetV24Q1 budgetAmount(Double budgetAmount) {
  ...
  **/
   ...
   * @return the CreateAdSetBudgetV24Q1 instance itself
   */
  public CreateAdSetBudgetV24Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAdSetBudgetV24Q1 createAdSetBudgetV24Q1 = (CreateAdSetBudgetV24Q1) o;
    return Objects.equals(this.budgetStrategy, createAdSetBudgetV24Q1.budgetStrategy) &&
        Objects.equals(this.budgetRenewal, createAdSetBudgetV24Q1.budgetRenewal) &&
        Objects.equals(this.budgetDeliverySmoothing, createAdSetBudgetV24Q1.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, createAdSetBudgetV24Q1.budgetDeliveryWeek) &&
        Objects.equals(this.budgetAmount, createAdSetBudgetV24Q1.budgetAmount)&&
        Objects.equals(this.additionalProperties, createAdSetBudgetV24Q1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAdSetBudgetV24Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateAdSetBudgetV24Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateAdSetBudgetV24Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAdSetBudgetV24Q1 is not found in the empty JSON string", CreateAdSetBudgetV24Q1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAdSetBudgetV24Q1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAdSetBudgetV24Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAdSetBudgetV24Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAdSetBudgetV24Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAdSetBudgetV24Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAdSetBudgetV24Q1>() {
           @Override
           public void write(JsonWriter out, CreateAdSetBudgetV24Q1 value) throws IOException {
           ...
           @Override
           public CreateAdSetBudgetV24Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateAdSetBudgetV24Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateAdSetBudgetV24Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateAdSetBudgetV24Q1
  * @throws IOException if the JSON string is invalid with respect to CreateAdSetBudgetV24Q1
  */
  public static CreateAdSetBudgetV24Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAdSetBudgetV24Q1.class);
  }

 /**
  * Convert an instance of CreateAdSetBudgetV24Q1 to an JSON string
  *
  * @return JSON string
  */
