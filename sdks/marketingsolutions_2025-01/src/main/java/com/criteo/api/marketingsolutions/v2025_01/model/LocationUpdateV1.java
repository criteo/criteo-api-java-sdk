...
import com.criteo.api.marketingsolutions.v2025_01.model.PointOfInterestV1;
...
public class LocationUpdateV1 {
  ...
  public LocationUpdateV1() {
  }

  public LocationUpdateV1 pointsOfInterest(List<PointOfInterestV1> pointsOfInterest) {
    
    this.pointsOfInterest = pointsOfInterest;
    return this;
  }

  public LocationUpdateV1 addPointsOfInterestItem(PointOfInterestV1 pointsOfInterestItem) {
  ...
  **/
  ...
  public LocationUpdateV1 registryType(RegistryTypeEnum registryType) {
  ...
  **/
   ...
   * @return the LocationUpdateV1 instance itself
   */
  public LocationUpdateV1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pointsOfInterest, locationUpdateV1.pointsOfInterest) &&
        ...
        Objects.equals(this.additionalProperties, locationUpdateV1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationUpdateV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationUpdateV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationUpdateV1 is not found in the empty JSON string", LocationUpdateV1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationUpdateV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationUpdateV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationUpdateV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationUpdateV1.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationUpdateV1>() {
           @Override
           public void write(JsonWriter out, LocationUpdateV1 value) throws IOException {
           ...
           @Override
           public LocationUpdateV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LocationUpdateV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LocationUpdateV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationUpdateV1
  * @throws IOException if the JSON string is invalid with respect to LocationUpdateV1
  */
  public static LocationUpdateV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationUpdateV1.class);
  }

 /**
  * Convert an instance of LocationUpdateV1 to an JSON string
  *
  * @return JSON string
  */
