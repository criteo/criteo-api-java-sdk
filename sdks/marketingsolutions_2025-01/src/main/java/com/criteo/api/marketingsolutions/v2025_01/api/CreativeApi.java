...
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceCollectionOutcomeOfAd;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceCollectionOutcomeOfCoupon;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceCollectionOutcomeOfCreative;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceInputOfAdWrite;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceInputOfCreateCoupon;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceInputOfCreativeWrite;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceInputOfUpdateCoupon;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceOutcomeOfAd;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceOutcomeOfCoupon;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceOutcomeOfCouponSupportedSizes;
import com.criteo.api.marketingsolutions.v2025_01.model.ResourceOutcomeOfCreative;
...
public class CreativeApi {
    ...
    public okhttp3.Call createAdvertiserAdCall(String advertiserId, ResourceInputOfAdWrite resourceInputOfAdWrite, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2025-01/marketing-solutions/advertisers/{advertiser-id}/ads"
    ...
    public okhttp3.Call createAdvertiserCouponCall(String advertiserId, ResourceInputOfCreateCoupon resourceInputOfCreateCoupon, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/advertisers/{advertiser-id}/coupons"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    public okhttp3.Call createAdvertiserCreativeCall(String advertiserId, ResourceInputOfCreativeWrite resourceInputOfCreativeWrite, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/advertisers/{advertiser-id}/creatives"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    public okhttp3.Call deleteAdCall(Integer id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/ads/{id}"
    ...
    public okhttp3.Call deleteAdvertiserCouponCall(String advertiserId, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call deleteCreativeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/creatives/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call generateCreativePreviewCall(String id, Integer width, Integer height, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/creatives/{id}/preview"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getAdvertiserCouponPreviewCall(String advertiserId, String id, Integer width, Integer height, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}/preview"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getAdvertiserCouponSupportedSizesCall(String advertiserId, String adSetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-01/marketing-solutions/advertisers/{advertiser-id}/coupons-supported-sizes"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
