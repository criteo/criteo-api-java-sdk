...
- Package version: 2021.07.0.220520
...
<dependency>
    ...
    <version>2021.07.0.220520</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2021.07.0.220520"
```
...
* `target/criteo-api-marketingsolutions-sdk-2021.07.0.220520.jar`
* `target/lib/*.jar`
