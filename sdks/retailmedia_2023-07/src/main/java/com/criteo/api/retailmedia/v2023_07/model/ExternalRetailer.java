...
public class ExternalRetailer {
  ...
  **/
   ...
   * @return the ExternalRetailer instance itself
   */
  public ExternalRetailer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, externalRetailer.name) &&
        ...
        Objects.equals(this.additionalProperties, externalRetailer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, campaignEligibilities, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExternalRetailer>() {
           ...
           public ExternalRetailer read(JsonReader in) throws IOException {
             ...
             ExternalRetailer instance = thisAdapter.fromJsonTree(jsonObj);
