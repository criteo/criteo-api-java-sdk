...
import com.criteo.api.retailmedia.v2023_07.model.JsonApiBodyWithIdOfInt64AndRetailerAndRetailer;
...
public class JsonApiPageResponseOfRetailer {
  ...
  **/
   ...
   * @return the JsonApiPageResponseOfRetailer instance itself
   */
  public JsonApiPageResponseOfRetailer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, jsonApiPageResponseOfRetailer.errors) &&
        ...
        Objects.equals(this.additionalProperties, jsonApiPageResponseOfRetailer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to JsonApiPageResponseOfRetailer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JsonApiPageResponseOfRetailer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonApiPageResponseOfRetailer is not found in the empty JSON string", JsonApiPageResponseOfRetailer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JsonApiPageResponseOfRetailer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonApiPageResponseOfRetailer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonApiPageResponseOfRetailer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonApiPageResponseOfRetailer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonApiPageResponseOfRetailer.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonApiPageResponseOfRetailer>() {
           @Override
           public void write(JsonWriter out, JsonApiPageResponseOfRetailer value) throws IOException {
           ...
           @Override
           public JsonApiPageResponseOfRetailer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JsonApiPageResponseOfRetailer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JsonApiPageResponseOfRetailer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JsonApiPageResponseOfRetailer
  * @throws IOException if the JSON string is invalid with respect to JsonApiPageResponseOfRetailer
  */
  public static JsonApiPageResponseOfRetailer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonApiPageResponseOfRetailer.class);
  }

 /**
  * Convert an instance of JsonApiPageResponseOfRetailer to an JSON string
  *
  * @return JSON string
  */
