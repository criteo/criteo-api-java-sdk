...
import com.criteo.api.retailmedia.v2023_07.model.RmLegacyAudienceGetEntityV1;
...
public class RmLegacyAudienceGetEntityV1Resource {
  ...
  public RmLegacyAudienceGetEntityV1Resource() {
  }

  public RmLegacyAudienceGetEntityV1Resource attributes(RmLegacyAudienceGetEntityV1 attributes) {
  ...
  **/
  ...
  public RmLegacyAudienceGetEntityV1 getAttributes() {
    return attributes;
  }


  public void setAttributes(RmLegacyAudienceGetEntityV1 attributes) {
    this.attributes = attributes;
  }
  ...
  **/
  ...
  public RmLegacyAudienceGetEntityV1Resource type(String type) {
  ...
  **/
   ...
   * @return the RmLegacyAudienceGetEntityV1Resource instance itself
   */
  public RmLegacyAudienceGetEntityV1Resource putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RmLegacyAudienceGetEntityV1Resource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RmLegacyAudienceGetEntityV1Resource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmLegacyAudienceGetEntityV1Resource is not found in the empty JSON string", RmLegacyAudienceGetEntityV1Resource.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmLegacyAudienceGetEntityV1Resource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmLegacyAudienceGetEntityV1Resource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmLegacyAudienceGetEntityV1Resource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmLegacyAudienceGetEntityV1Resource.class));

       return (TypeAdapter<T>) new TypeAdapter<RmLegacyAudienceGetEntityV1Resource>() {
           @Override
           public void write(JsonWriter out, RmLegacyAudienceGetEntityV1Resource value) throws IOException {
           ...
           @Override
           public RmLegacyAudienceGetEntityV1Resource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RmLegacyAudienceGetEntityV1Resource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RmLegacyAudienceGetEntityV1Resource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RmLegacyAudienceGetEntityV1Resource
  * @throws IOException if the JSON string is invalid with respect to RmLegacyAudienceGetEntityV1Resource
  */
  public static RmLegacyAudienceGetEntityV1Resource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmLegacyAudienceGetEntityV1Resource.class);
  }

 /**
  * Convert an instance of RmLegacyAudienceGetEntityV1Resource to an JSON string
  *
  * @return JSON string
  */
