...
import com.criteo.api.marketingsolutions.v2025_10.model.Outcome;
import com.criteo.api.marketingsolutions.v2025_10.model.ResourceCollectionOutcomeOfProductSet;
import com.criteo.api.marketingsolutions.v2025_10.model.ResourceOutcomeOfProductSet;
import com.criteo.api.marketingsolutions.v2025_10.model.ValueResourceCollectionOutcomeOfProductFilterConfig;
import com.criteo.api.marketingsolutions.v2025_10.model.ValueResourceInputOfCreateProductFilterRequest;
import com.criteo.api.marketingsolutions.v2025_10.model.ValueResourceInputOfCreateProductSetRequest;
import com.criteo.api.marketingsolutions.v2025_10.model.ValueResourceInputOfPatchProductSetRequest;
import com.criteo.api.marketingsolutions.v2025_10.model.ValueResourceOutcomeOfProductFilterConfig;
...
public class RecoApi {
    ...
    /**
     * /2025-10/marketing-solutions/product-sets (asynchronously)
     * Create a new product set
     * @param valueResourceInputOfCreateProductSetRequest  (required)
    ...
    /**
     * /2025-10/marketing-solutions/ads/{ad-id}/product-filter (asynchronously)
     * Disable product filtering for a given ad
     * @param adId ID of the ad (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * /2025-10/marketing-solutions/product-sets/{product-set-id}/product-filters (asynchronously)
     * Fetch product filtering usages for a given product set
     * @param productSetId ID of the product set (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * /2025-10/marketing-solutions/product-sets/{product-set-id} (asynchronously)
     * Fetch an existing product set
     * @param productSetId ID of the product set (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * /2025-10/marketing-solutions/product-sets/dataset/{dataset-id} (asynchronously)
     * Fetch product sets of a given dataset
     * @param datasetId The ID of the dataset that should be used for product set retrieval (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
