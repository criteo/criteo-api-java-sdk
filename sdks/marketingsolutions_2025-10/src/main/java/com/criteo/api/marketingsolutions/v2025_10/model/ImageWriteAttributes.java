...
public class ImageWriteAttributes {
  ...
  **/
  ...
  public ImageWriteAttributes landingPageUrl(URI landingPageUrl) {
  ...
  **/
   ...
   * @return the ImageWriteAttributes instance itself
   */
  public ImageWriteAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.base64Strings, imageWriteAttributes.base64Strings) &&
        ...
        Objects.equals(this.additionalProperties, imageWriteAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(base64Strings, landingPageUrl, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("base64Strings");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageWriteAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageWriteAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageWriteAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageWriteAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageWriteAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageWriteAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageWriteAttributes>() {
           @Override
           public void write(JsonWriter out, ImageWriteAttributes value) throws IOException {
           ...
           @Override
           public ImageWriteAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageWriteAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageWriteAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageWriteAttributes
  * @throws IOException if the JSON string is invalid with respect to ImageWriteAttributes
  */
  public static ImageWriteAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageWriteAttributes.class);
  }

 /**
  * Convert an instance of ImageWriteAttributes to an JSON string
  *
  * @return JSON string
  */
