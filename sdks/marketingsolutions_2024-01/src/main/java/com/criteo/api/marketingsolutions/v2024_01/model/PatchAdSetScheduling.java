...
public class PatchAdSetScheduling {
  ...
  **/
   ...
   * @return the PatchAdSetScheduling instance itself
   */
  public PatchAdSetScheduling putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchAdSetScheduling
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchAdSetScheduling.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAdSetScheduling.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAdSetScheduling' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAdSetScheduling> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAdSetScheduling.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAdSetScheduling>() {
           @Override
           public void write(JsonWriter out, PatchAdSetScheduling value) throws IOException {
           ...
           @Override
           public PatchAdSetScheduling read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchAdSetScheduling instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchAdSetScheduling given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchAdSetScheduling
  * @throws IOException if the JSON string is invalid with respect to PatchAdSetScheduling
  */
  public static PatchAdSetScheduling fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAdSetScheduling.class);
  }

 /**
  * Convert an instance of PatchAdSetScheduling to an JSON string
  *
  * @return JSON string
  */
