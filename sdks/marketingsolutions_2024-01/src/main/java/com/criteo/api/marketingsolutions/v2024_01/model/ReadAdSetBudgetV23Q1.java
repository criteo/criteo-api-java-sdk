...
import com.criteo.api.marketingsolutions.v2024_01.model.NillableDecimal;
...
public class ReadAdSetBudgetV23Q1 {
  ...
  public ReadAdSetBudgetV23Q1() {
  }

  public ReadAdSetBudgetV23Q1 budgetAmount(NillableDecimal budgetAmount) {
  ...
  **/
  ...
  public ReadAdSetBudgetV23Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public ReadAdSetBudgetV23Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public ReadAdSetBudgetV23Q1 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public ReadAdSetBudgetV23Q1 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
   ...
   * @return the ReadAdSetBudgetV23Q1 instance itself
   */
  public ReadAdSetBudgetV23Q1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReadAdSetBudgetV23Q1 readAdSetBudgetV23Q1 = (ReadAdSetBudgetV23Q1) o;
    return Objects.equals(this.budgetAmount, readAdSetBudgetV23Q1.budgetAmount) &&
        Objects.equals(this.budgetDeliverySmoothing, readAdSetBudgetV23Q1.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, readAdSetBudgetV23Q1.budgetDeliveryWeek) &&
        Objects.equals(this.budgetRenewal, readAdSetBudgetV23Q1.budgetRenewal) &&
        Objects.equals(this.budgetStrategy, readAdSetBudgetV23Q1.budgetStrategy)&&
        Objects.equals(this.additionalProperties, readAdSetBudgetV23Q1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReadAdSetBudgetV23Q1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReadAdSetBudgetV23Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReadAdSetBudgetV23Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReadAdSetBudgetV23Q1 is not found in the empty JSON string", ReadAdSetBudgetV23Q1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReadAdSetBudgetV23Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReadAdSetBudgetV23Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReadAdSetBudgetV23Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReadAdSetBudgetV23Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<ReadAdSetBudgetV23Q1>() {
           @Override
           public void write(JsonWriter out, ReadAdSetBudgetV23Q1 value) throws IOException {
           ...
           @Override
           public ReadAdSetBudgetV23Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReadAdSetBudgetV23Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReadAdSetBudgetV23Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReadAdSetBudgetV23Q1
  * @throws IOException if the JSON string is invalid with respect to ReadAdSetBudgetV23Q1
  */
  public static ReadAdSetBudgetV23Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReadAdSetBudgetV23Q1.class);
  }

 /**
  * Convert an instance of ReadAdSetBudgetV23Q1 to an JSON string
  *
  * @return JSON string
  */
