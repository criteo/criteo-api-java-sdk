...
public class AdResponse {
  ...
  public AdResponse data(AdResource data) {
  ...
  **/
  ...
  public AdResource getData() {
    return data;
  }


  public void setData(AdResource data) {
    this.data = data;
  }
  ...
  **/
   ...
   * @return the AdResponse instance itself
   */
  public AdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, adResponse.data) &&
        Objects.equals(this.warnings, adResponse.warnings) &&
        Objects.equals(this.errors, adResponse.errors)&&
        Objects.equals(this.additionalProperties, adResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        AdResource.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AdResponse>() {
           ...
           public AdResponse read(JsonReader in) throws IOException {
             ...
             AdResponse instance = thisAdapter.fromJsonTree(jsonObj);
