...
------------- | ------------- | -------------
[**deleteApiV1ExternalBalanceCampaignsByBalanceId**](CampaignApi.md#deleteApiV1ExternalBalanceCampaignsByBalanceId) | **DELETE** /2021-07/retail-media/balances/{balanceId}/campaigns | 
[**deleteApiV1ExternalLineItemProductsByLineItemId**](CampaignApi.md#deleteApiV1ExternalLineItemProductsByLineItemId) | **DELETE** /2021-07/retail-media/line-items/{lineItemId}/products | 
[**deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId**](CampaignApi.md#deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId) | **DELETE** /2021-07/retail-media/line-items/{line-item-id}/targeting/keywords | 
[**getApiV1ExternalAccountBalancesByAccountId**](CampaignApi.md#getApiV1ExternalAccountBalancesByAccountId) | **GET** /2021-07/retail-media/accounts/{accountId}/balances | 
...
[**getApiV1ExternalBalanceCampaignsByBalanceId**](CampaignApi.md#getApiV1ExternalBalanceCampaignsByBalanceId) | **GET** /2021-07/retail-media/balances/{balanceId}/campaigns | 
...
[**getApiV1ExternalLineItemProductsByLineItemId**](CampaignApi.md#getApiV1ExternalLineItemProductsByLineItemId) | **GET** /2021-07/retail-media/line-items/{lineItemId}/products | 
...
[**getApiV2ExternalCampaignPreferredLineItemsByCampaignId**](CampaignApi.md#getApiV2ExternalCampaignPreferredLineItemsByCampaignId) | **GET** /2021-07/retail-media/campaigns/{campaign-id}/preferred-line-items | 
...
[**getApiV2ExternalLineItemTargetingKeywordsByLineItemId**](CampaignApi.md#getApiV2ExternalLineItemTargetingKeywordsByLineItemId) | **GET** /2021-07/retail-media/line-items/{line-item-id}/targeting/keywords | 
[**getApiV2ExternalPreferredLineItemByLineItemId**](CampaignApi.md#getApiV2ExternalPreferredLineItemByLineItemId) | **GET** /2021-07/retail-media/preferred-line-items/{line-item-id} | 
...
[**postApiV2ExternalCampaignPreferredLineItemsByCampaignId**](CampaignApi.md#postApiV2ExternalCampaignPreferredLineItemsByCampaignId) | **POST** /2021-07/retail-media/campaigns/{campaign-id}/preferred-line-items | 
[**putApiV1ExternalBalanceCampaignsByBalanceId**](CampaignApi.md#putApiV1ExternalBalanceCampaignsByBalanceId) | **PUT** /2021-07/retail-media/balances/{balanceId}/campaigns | 
...
[**putApiV1ExternalLineItemProductsByLineItemId**](CampaignApi.md#putApiV1ExternalLineItemProductsByLineItemId) | **PUT** /2021-07/retail-media/line-items/{lineItemId}/products | 
...
[**putApiV2ExternalLineItemTargetingKeywordsByLineItemId**](CampaignApi.md#putApiV2ExternalLineItemTargetingKeywordsByLineItemId) | **PUT** /2021-07/retail-media/line-items/{line-item-id}/targeting/keywords | 
[**putApiV2ExternalPreferredLineItemByLineItemId**](CampaignApi.md#putApiV2ExternalPreferredLineItemByLineItemId) | **PUT** /2021-07/retail-media/preferred-line-items/{line-item-id} | 
...
<a name="deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId"></a>
# **deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId**
> KeywordTargetResponse deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId(lineItemId, keywordTargetRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    CampaignApi apiInstance = new CampaignApi(defaultClient);
    String lineItemId = "lineItemId_example"; // String | The line item to interact with
    KeywordTargetRequest keywordTargetRequest = new KeywordTargetRequest(); // KeywordTargetRequest | 
    try {
      KeywordTargetResponse result = apiInstance.deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId(lineItemId, keywordTargetRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CampaignApi#deleteApiV2ExternalLineItemTargetingKeywordsByLineItemId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
------------- | ------------- | ------------- | -------------
 **lineItemId** | **String**| The line item to interact with |
 **keywordTargetRequest** | [**KeywordTargetRequest**](KeywordTargetRequest.md)|  | [optional]

### Return type

[**KeywordTargetResponse**](KeywordTargetResponse.md)
...
<a name="getApiV2ExternalCampaignPreferredLineItemsByCampaignId"></a>
# **getApiV2ExternalCampaignPreferredLineItemsByCampaignId**
> PreferredLineItemPagedListResponse getApiV2ExternalCampaignPreferredLineItemsByCampaignId(campaignId, limitToId, pageIndex, pageSize)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer pageSize = 56; // Integer | The maximum number of items you would like to receive in this request
    try {
      PreferredLineItemPagedListResponse result = apiInstance.getApiV2ExternalCampaignPreferredLineItemsByCampaignId(campaignId, limitToId, pageIndex, pageSize);
      System.out.println(result);
    } catch (ApiException e) {
...
[**PreferredLineItemPagedListResponse**](PreferredLineItemPagedListResponse.md)
...
<a name="getApiV2ExternalLineItemByLineItemId"></a>
...
<a name="getApiV2ExternalLineItemTargetingKeywordsByLineItemId"></a>
# **getApiV2ExternalLineItemTargetingKeywordsByLineItemId**
> KeywordTargetResponse getApiV2ExternalLineItemTargetingKeywordsByLineItemId(lineItemId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String lineItemId = "lineItemId_example"; // String | The line item to interact with
    try {
      KeywordTargetResponse result = apiInstance.getApiV2ExternalLineItemTargetingKeywordsByLineItemId(lineItemId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CampaignApi#getApiV2ExternalLineItemTargetingKeywordsByLineItemId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getApiV2ExternalPreferredLineItemByLineItemId"></a>
# **getApiV2ExternalPreferredLineItemByLineItemId**
> PreferredLineItemResponse getApiV2ExternalPreferredLineItemByLineItemId(lineItemId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String lineItemId = "lineItemId_example"; // String | The given line item id
    try {
      PreferredLineItemResponse result = apiInstance.getApiV2ExternalPreferredLineItemByLineItemId(lineItemId);
      System.out.println(result);
    } catch (ApiException e) {
...
<a name="postApiV2ExternalCampaignAuctionLineItemsByCampaignId"></a>
...
<a name="postApiV2ExternalCampaignPreferredLineItemsByCampaignId"></a>
# **postApiV2ExternalCampaignPreferredLineItemsByCampaignId**
> PreferredLineItemResponse postApiV2ExternalCampaignPreferredLineItemsByCampaignId(campaignId, preferredLineItemCreateModelRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    CampaignApi apiInstance = new CampaignApi(defaultClient);
    String campaignId = "campaignId_example"; // String | The given campaign id
    PreferredLineItemCreateModelRequest preferredLineItemCreateModelRequest = new PreferredLineItemCreateModelRequest(); // PreferredLineItemCreateModelRequest | The line item settings to create a line item with
    try {
      PreferredLineItemResponse result = apiInstance.postApiV2ExternalCampaignPreferredLineItemsByCampaignId(campaignId, preferredLineItemCreateModelRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CampaignApi#postApiV2ExternalCampaignPreferredLineItemsByCampaignId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
------------- | ------------- | ------------- | -------------
 **campaignId** | **String**| The given campaign id |
 **preferredLineItemCreateModelRequest** | [**PreferredLineItemCreateModelRequest**](PreferredLineItemCreateModelRequest.md)| The line item settings to create a line item with | [optional]
...
<a name="putApiV2ExternalAuctionLineItemByLineItemId"></a>
...
<a name="putApiV2ExternalLineItemTargetingKeywordsByLineItemId"></a>
# **putApiV2ExternalLineItemTargetingKeywordsByLineItemId**
> KeywordTargetResponse putApiV2ExternalLineItemTargetingKeywordsByLineItemId(lineItemId, keywordTargetRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeywordTargetRequest keywordTargetRequest = new KeywordTargetRequest(); // KeywordTargetRequest | 
    try {
      KeywordTargetResponse result = apiInstance.putApiV2ExternalLineItemTargetingKeywordsByLineItemId(lineItemId, keywordTargetRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CampaignApi#putApiV2ExternalLineItemTargetingKeywordsByLineItemId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="putApiV2ExternalPreferredLineItemByLineItemId"></a>
