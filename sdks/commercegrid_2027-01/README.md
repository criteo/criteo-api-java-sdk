# JAVA SDK for Criteo API commercegrid for 2027_01 version
...
```groovy
compile "com.criteo:criteo-api-commercegrid-sdk:2027.01.0.260831"
```
...
* `build/libs/criteo-api-commercegrid-sdk-2027.01.0.260831.jar`

## Example

Please see [src/test/java/com/criteo/api/commercegrid/v2027_01/ExampleApplication.java](src/test/java/com/criteo/api/commercegrid/v2027_01/ExampleApplication.java) for an example on how to perform a simple call.
...
------------ | ------------- | ------------- | -------------
*GatewayApi* | [**getCurrentApplication**](docs/GatewayApi.md#getCurrentApplication) | **GET** /2027-01/commerce-grid/me | /2027-01/commerce-grid/me
*SegmentApi* | [**addRemoveContactListByAudienceSegment**](docs/SegmentApi.md#addRemoveContactListByAudienceSegment) | **POST** /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/add-remove | /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/add-remove
*SegmentApi* | [**bulkCreateAudienceSegments**](docs/SegmentApi.md#bulkCreateAudienceSegments) | **POST** /2027-01/commerce-grid/audience-segments/create | /2027-01/commerce-grid/audience-segments/create
*SegmentApi* | [**bulkDeleteAudienceSegments**](docs/SegmentApi.md#bulkDeleteAudienceSegments) | **POST** /2027-01/commerce-grid/audience-segments/delete | /2027-01/commerce-grid/audience-segments/delete
*SegmentApi* | [**bulkUpdateAudienceSegments**](docs/SegmentApi.md#bulkUpdateAudienceSegments) | **PATCH** /2027-01/commerce-grid/audience-segments | /2027-01/commerce-grid/audience-segments
*SegmentApi* | [**clearContactListByAudienceSegment**](docs/SegmentApi.md#clearContactListByAudienceSegment) | **POST** /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/clear | /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/clear
*SegmentApi* | [**getAudienceSegmentContactListStatistics**](docs/SegmentApi.md#getAudienceSegmentContactListStatistics) | **GET** /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/statistics | /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/statistics
*SegmentApi* | [**searchAudienceSegments**](docs/SegmentApi.md#searchAudienceSegments) | **POST** /2027-01/commerce-grid/audience-segments/search | /2027-01/commerce-grid/audience-segments/search
