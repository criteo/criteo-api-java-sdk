...
import com.criteo.api.marketingsolutions.v2023_10.model.AdSetTargeting;
import com.criteo.api.marketingsolutions.v2023_10.model.PatchAdSetBidding;
import com.criteo.api.marketingsolutions.v2023_10.model.PatchAdSetBudget;
import com.criteo.api.marketingsolutions.v2023_10.model.PatchAdSetScheduling;
...
public class PatchAdSet {
  ...
  **/
   ...
   * @return the PatchAdSet instance itself
   */
  public PatchAdSet putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchAdSet
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchAdSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAdSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAdSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAdSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAdSet.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAdSet>() {
           @Override
           public void write(JsonWriter out, PatchAdSet value) throws IOException {
           ...
           @Override
           public PatchAdSet read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchAdSet instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchAdSet given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchAdSet
  * @throws IOException if the JSON string is invalid with respect to PatchAdSet
  */
  public static PatchAdSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAdSet.class);
  }

 /**
  * Convert an instance of PatchAdSet to an JSON string
  *
  * @return JSON string
  */
