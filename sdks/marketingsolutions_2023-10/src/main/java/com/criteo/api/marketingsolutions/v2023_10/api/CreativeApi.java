...
import com.criteo.api.marketingsolutions.v2023_10.model.AdListResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.AdResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.AdWriteRequest;
import com.criteo.api.marketingsolutions.v2023_10.model.CouponListResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.CouponResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.CouponSupportedSizesResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.CreateCouponRequest;
import com.criteo.api.marketingsolutions.v2023_10.model.CreativeListResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.CreativeResponse;
import com.criteo.api.marketingsolutions.v2023_10.model.CreativeWriteRequest;
import com.criteo.api.marketingsolutions.v2023_10.model.UpdateCouponRequest;
...
public class CreativeApi {
    ...
    public okhttp3.Call createAdvertiserAdCall(String advertiserId, AdWriteRequest adWriteRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2023-10/marketing-solutions/advertisers/{advertiser-id}/ads"
    ...
    public okhttp3.Call createAdvertiserCouponCall(String advertiserId, CreateCouponRequest createCouponRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/advertisers/{advertiser-id}/coupons"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    public okhttp3.Call createAdvertiserCreativeCall(String advertiserId, CreativeWriteRequest creativeWriteRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/advertisers/{advertiser-id}/creatives"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    public okhttp3.Call deleteAdCall(Integer id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/ads/{id}"
    ...
    public okhttp3.Call deleteAdvertiserCouponCall(String advertiserId, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call deleteCreativeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/creatives/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call generateCreativePreviewCall(String id, Integer width, Integer height, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/creatives/{id}/preview"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getAdvertiserCouponPreviewCall(String advertiserId, String id, Integer width, Integer height, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}/preview"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    public okhttp3.Call getAdvertiserCouponSupportedSizesCall(String advertiserId, String adSetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2023-10/marketing-solutions/advertisers/{advertiser-id}/coupons-supported-sizes"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
