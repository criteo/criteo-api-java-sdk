...
public class ExternalCatalogStatus {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, currency, fileSizeBytes, md5Checksum, message, rowCount, status);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ExternalCatalogStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExternalCatalogStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
