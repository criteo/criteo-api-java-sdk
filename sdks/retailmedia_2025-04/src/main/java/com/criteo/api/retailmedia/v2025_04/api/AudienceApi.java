...
import com.criteo.api.retailmedia.v2025_04.model.ErrorCodeResponse;
import com.criteo.api.retailmedia.v2025_04.model.RetailMediaContactlistAmendmentRequest;
import com.criteo.api.retailmedia.v2025_04.model.RetailMediaContactlistOperation;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceEntityV1RmAudienceSearchMetadataV1ListResponse;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSearchInputV1;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentBulkCreateInputV1;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentBulkDeleteInputV1;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentBulkUpdateInputV1;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentEntityV1ListResponse;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentEntityV1RmAudienceSegmentSearchMetadataV1ListResponse;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentIdEntityV1ListResponse;
import com.criteo.api.retailmedia.v2025_04.model.RmAudienceSegmentSearchInputV1;
import com.criteo.api.retailmedia.v2025_04.model.RmContactListStatisticsEntityV1Response;
...
public class AudienceApi {
    ...
    public okhttp3.Call bulkCreateAudienceSegmentsCall(String accountId, RmAudienceSegmentBulkCreateInputV1 rmAudienceSegmentBulkCreateInputV1, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2025-04/retail-media/accounts/{account-id}/audience-segments/create"
    ...
    public okhttp3.Call bulkDeleteAudienceSegmentsCall(String accountId, RmAudienceSegmentBulkDeleteInputV1 rmAudienceSegmentBulkDeleteInputV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/accounts/{account-id}/audience-segments/delete"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call bulkUpdateAudienceSegmentsCall(String accountId, RmAudienceSegmentBulkUpdateInputV1 rmAudienceSegmentBulkUpdateInputV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/accounts/{account-id}/audience-segments"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call deleteContactListIdentifiersCall(Long audienceSegmentId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/audience-segments/{audience-segment-id}/contact-list/clear"
    ...
    public okhttp3.Call getAudienceSegmentContactListStatisticsCall(String accountId, String audienceSegmentId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/accounts/{account-id}/audience-segments/{audience-segment-id}/contact-list"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()))
            .replace("{" + "audience-segment-id" + "}", localVarApiClient.escapeString(audienceSegmentId.toString()));
    ...
    public okhttp3.Call searchAudienceSegmentsCall(String accountId, RmAudienceSegmentSearchInputV1 rmAudienceSegmentSearchInputV1, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/accounts/{account-id}/audience-segments/search"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call searchAudiencesCall(String accountId, RmAudienceSearchInputV1 rmAudienceSearchInputV1, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/accounts/{account-id}/audiences/search"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public okhttp3.Call updateContactListIdentifiersCall(Long audienceSegmentId, RetailMediaContactlistAmendmentRequest retailMediaContactlistAmendmentRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2025-04/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove"
            .replace("{" + "audience-segment-id" + "}", localVarApiClient.escapeString(audienceSegmentId.toString()));
