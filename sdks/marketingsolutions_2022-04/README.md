...
- Package version: 2022.04.0.230327
...
<dependency>
    ...
    <version>2022.04.0.230327</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.230327"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.230327.jar`
* `target/lib/*.jar`
