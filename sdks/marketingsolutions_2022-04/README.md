...
<dependency>
    ...
    <version>2022.04.0.220520</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.220520"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.220520.jar`
* `target/lib/*.jar`
