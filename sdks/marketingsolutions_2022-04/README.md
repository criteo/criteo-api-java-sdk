...
- Package version: 2022.04.0.220927
...
<dependency>
    ...
    <version>2022.04.0.220927</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.220927"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.220927.jar`
* `target/lib/*.jar`
