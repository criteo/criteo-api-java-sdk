...
- Package version: 2022.04.0.220725
...
<dependency>
    ...
    <version>2022.04.0.220725</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.220725"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.220725.jar`
* `target/lib/*.jar`
