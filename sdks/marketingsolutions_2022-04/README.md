...
- Package version: 2022.04.0.221102
...
<dependency>
    ...
    <version>2022.04.0.221102</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.221102"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.221102.jar`
* `target/lib/*.jar`
