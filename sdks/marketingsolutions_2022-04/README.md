...
<dependency>
    ...
    <version>2022.04.0.230216</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.230216"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.230216.jar`
* `target/lib/*.jar`
