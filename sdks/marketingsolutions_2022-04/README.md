...
- Package version: 2022.04.0.230224
...
<dependency>
    ...
    <version>2022.04.0.230224</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2022.04.0.230224"
```
...
* `target/criteo-api-marketingsolutions-sdk-2022.04.0.230224.jar`
* `target/lib/*.jar`
