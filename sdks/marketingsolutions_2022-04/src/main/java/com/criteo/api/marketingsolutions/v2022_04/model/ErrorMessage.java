...
public class ErrorMessage {
  ...
  **/
   ...
   * @return the ErrorMessage instance itself
   */
  public ErrorMessage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.traceId, errorMessage.traceId) &&
        ...
        Objects.equals(this.additionalProperties, errorMessage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(traceId, traceIdentifier, type, code, instance, title, detail, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ErrorMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorMessage>() {
           ...
           public ErrorMessage read(JsonReader in) throws IOException {
             ...
             ErrorMessage instance = thisAdapter.fromJsonTree(jsonObj);
