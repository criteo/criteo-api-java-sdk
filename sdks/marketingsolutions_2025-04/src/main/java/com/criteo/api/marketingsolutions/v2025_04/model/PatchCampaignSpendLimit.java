...
/**
 * Spend limit configuration for a marketing campaign (patch).  Only provided fields are updated; omitted fields are left unchanged.  When spendLimitType is \&quot;capped\&quot;: spendLimitAmount and spendLimitRenewal are required.  When spendLimitType is \&quot;uncapped\&quot;: spendLimitAmount is null and spendLimitRenewal is \&quot;undefined\&quot;.
 */
...
public class PatchCampaignSpendLimit {
  ...
  public PatchCampaignSpendLimit() {
  }
  ...
  **/
   ...
   * @return the PatchCampaignSpendLimit instance itself
   */
  public PatchCampaignSpendLimit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.spendLimitAmount, patchCampaignSpendLimit.spendLimitAmount) &&
        Objects.equals(this.spendLimitRenewal, patchCampaignSpendLimit.spendLimitRenewal) &&
        Objects.equals(this.spendLimitType, patchCampaignSpendLimit.spendLimitType)&&
        Objects.equals(this.additionalProperties, patchCampaignSpendLimit.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchCampaignSpendLimit
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchCampaignSpendLimit.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchCampaignSpendLimit is not found in the empty JSON string", PatchCampaignSpendLimit.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchCampaignSpendLimit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchCampaignSpendLimit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchCampaignSpendLimit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchCampaignSpendLimit.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchCampaignSpendLimit>() {
           @Override
           public void write(JsonWriter out, PatchCampaignSpendLimit value) throws IOException {
           ...
           @Override
           public PatchCampaignSpendLimit read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchCampaignSpendLimit instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchCampaignSpendLimit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchCampaignSpendLimit
  * @throws IOException if the JSON string is invalid with respect to PatchCampaignSpendLimit
  */
  public static PatchCampaignSpendLimit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchCampaignSpendLimit.class);
  }

 /**
  * Convert an instance of PatchCampaignSpendLimit to an JSON string
  *
  * @return JSON string
  */
