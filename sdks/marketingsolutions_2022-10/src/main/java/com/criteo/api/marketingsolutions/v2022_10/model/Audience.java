...
import com.criteo.api.marketingsolutions.v2022_10.model.AudienceAttributes;
...
public class Audience {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Audience.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      AudienceAttributes.validateJsonObject(jsonObj.getAsJsonObject("attributes"));
  }
