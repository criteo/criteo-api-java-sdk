...
public class LocationSizeEstimationV1 {
  ...
  public LocationSizeEstimationV1() {
  }
  ...
  **/
   ...
   * @return the LocationSizeEstimationV1 instance itself
   */
  public LocationSizeEstimationV1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pointsOfInterest, locationSizeEstimationV1.pointsOfInterest) &&
        ...
        Objects.equals(this.additionalProperties, locationSizeEstimationV1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationSizeEstimationV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationSizeEstimationV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationSizeEstimationV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationSizeEstimationV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationSizeEstimationV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationSizeEstimationV1.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationSizeEstimationV1>() {
           @Override
           public void write(JsonWriter out, LocationSizeEstimationV1 value) throws IOException {
           ...
           @Override
           public LocationSizeEstimationV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LocationSizeEstimationV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LocationSizeEstimationV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationSizeEstimationV1
  * @throws IOException if the JSON string is invalid with respect to LocationSizeEstimationV1
  */
  public static LocationSizeEstimationV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationSizeEstimationV1.class);
  }

 /**
  * Convert an instance of LocationSizeEstimationV1 to an JSON string
  *
  * @return JSON string
  */
