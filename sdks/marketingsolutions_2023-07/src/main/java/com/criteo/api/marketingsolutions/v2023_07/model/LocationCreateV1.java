...
public class LocationCreateV1 {
  ...
  **/
   ...
   * @return the LocationCreateV1 instance itself
   */
  public LocationCreateV1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pointsOfInterest, locationCreateV1.pointsOfInterest) &&
        ...
        Objects.equals(this.additionalProperties, locationCreateV1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pointsOfInterest, radiusInKm, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationCreateV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationCreateV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationCreateV1 is not found in the empty JSON string", LocationCreateV1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocationCreateV1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationCreateV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationCreateV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationCreateV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationCreateV1.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationCreateV1>() {
           @Override
           public void write(JsonWriter out, LocationCreateV1 value) throws IOException {
           ...
           @Override
           public LocationCreateV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LocationCreateV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LocationCreateV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationCreateV1
  * @throws IOException if the JSON string is invalid with respect to LocationCreateV1
  */
  public static LocationCreateV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationCreateV1.class);
  }

 /**
  * Convert an instance of LocationCreateV1 to an JSON string
  *
  * @return JSON string
  */
