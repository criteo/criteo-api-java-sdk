...
import com.criteo.api.marketingsolutions.v2025_07.model.NillableDecimal;
...
public class PatchAdSetBudgetV24Q3 {
  ...
  public PatchAdSetBudgetV24Q3() {
  }

  public PatchAdSetBudgetV24Q3 budgetAmount(NillableDecimal budgetAmount) {
  ...
  **/
  ...
  public PatchAdSetBudgetV24Q3 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public PatchAdSetBudgetV24Q3 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
  ...
  public PatchAdSetBudgetV24Q3 budgetRenewal(BudgetRenewalEnum budgetRenewal) {
  ...
  **/
  ...
  public PatchAdSetBudgetV24Q3 budgetStrategy(BudgetStrategyEnum budgetStrategy) {
  ...
  **/
   ...
   * @return the PatchAdSetBudgetV24Q3 instance itself
   */
  public PatchAdSetBudgetV24Q3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchAdSetBudgetV24Q3 patchAdSetBudgetV24Q3 = (PatchAdSetBudgetV24Q3) o;
    return Objects.equals(this.budgetAmount, patchAdSetBudgetV24Q3.budgetAmount) &&
        Objects.equals(this.budgetDeliverySmoothing, patchAdSetBudgetV24Q3.budgetDeliverySmoothing) &&
        Objects.equals(this.budgetDeliveryWeek, patchAdSetBudgetV24Q3.budgetDeliveryWeek) &&
        Objects.equals(this.budgetRenewal, patchAdSetBudgetV24Q3.budgetRenewal) &&
        Objects.equals(this.budgetStrategy, patchAdSetBudgetV24Q3.budgetStrategy)&&
        Objects.equals(this.additionalProperties, patchAdSetBudgetV24Q3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchAdSetBudgetV24Q3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchAdSetBudgetV24Q3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchAdSetBudgetV24Q3 is not found in the empty JSON string", PatchAdSetBudgetV24Q3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAdSetBudgetV24Q3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAdSetBudgetV24Q3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAdSetBudgetV24Q3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAdSetBudgetV24Q3.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAdSetBudgetV24Q3>() {
           @Override
           public void write(JsonWriter out, PatchAdSetBudgetV24Q3 value) throws IOException {
           ...
           @Override
           public PatchAdSetBudgetV24Q3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchAdSetBudgetV24Q3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchAdSetBudgetV24Q3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchAdSetBudgetV24Q3
  * @throws IOException if the JSON string is invalid with respect to PatchAdSetBudgetV24Q3
  */
  public static PatchAdSetBudgetV24Q3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAdSetBudgetV24Q3.class);
  }

 /**
  * Convert an instance of PatchAdSetBudgetV24Q3 to an JSON string
  *
  * @return JSON string
  */
