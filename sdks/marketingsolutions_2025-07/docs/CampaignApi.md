...
> byte[] sellerCampaigns(advertiserId, campaignId, clickAttributionPolicy, count, endDate, intervalSize, sellerId, startDate)
...
public class Example {
    public static void main(String[] args) {
        ...
        OffsetDateTime startDate = OffsetDateTime.now(); // OffsetDateTime | Filter out all events that occur before date (default is the value of `endDate`)
        try {
            byte[] result = apiInstance.sellerCampaigns(advertiserId, campaignId, clickAttributionPolicy, count, endDate, intervalSize, sellerId, startDate);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CampaignApi#sellerCampaigns");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> byte[] sellers(advertiserId, clickAttributionPolicy, count, endDate, intervalSize, sellerId, startDate)
...
public class Example {
    public static void main(String[] args) {
        ...
        OffsetDateTime startDate = OffsetDateTime.now(); // OffsetDateTime | Filter out all events that occur before date (default is the value of `endDate`)
        try {
            byte[] result = apiInstance.sellers(advertiserId, clickAttributionPolicy, count, endDate, intervalSize, sellerId, startDate);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CampaignApi#sellers");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> updateSellerBudget(budgetId, updateSellerBudgetMessageBase)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateSellerBudget(budgetId, updateSellerBudgetMessageBase);
        } catch (ApiException e) {
            System.err.println("Exception when calling CampaignApi#updateSellerBudget");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> updateSellerBudgets(updateSellerBudgetMessage)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.updateSellerBudgets(updateSellerBudgetMessage);
        } catch (ApiException e) {
            System.err.println("Exception when calling CampaignApi#updateSellerBudgets");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> SellerCampaignMessage updateSellerCampaign(sellerCampaignId, bid)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            SellerCampaignMessage result = apiInstance.updateSellerCampaign(sellerCampaignId, bid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CampaignApi#updateSellerCampaign");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;SellerCampaignMessage&gt; updateSellerCampaigns(sellerCampaignUpdate)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<SellerCampaignMessage> result = apiInstance.updateSellerCampaigns(sellerCampaignUpdate);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CampaignApi#updateSellerCampaigns");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
