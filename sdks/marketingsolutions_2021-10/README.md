...
- Package version: 2021.10.0.220624
...
<dependency>
    ...
    <version>2021.10.0.220624</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2021.10.0.220624"
```
...
* `target/criteo-api-marketingsolutions-sdk-2021.10.0.220624.jar`
* `target/lib/*.jar`
