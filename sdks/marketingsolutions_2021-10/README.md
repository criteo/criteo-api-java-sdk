...
- Package version: 2021.10.0.221026
...
<dependency>
    ...
    <version>2021.10.0.221026</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2021.10.0.221026"
```
...
* `target/criteo-api-marketingsolutions-sdk-2021.10.0.221026.jar`
* `target/lib/*.jar`
