...
- Package version: 2021.10.0.221229
...
<dependency>
    ...
    <version>2021.10.0.221229</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2021.10.0.221229"
```
...
* `target/criteo-api-marketingsolutions-sdk-2021.10.0.221229.jar`
* `target/lib/*.jar`
