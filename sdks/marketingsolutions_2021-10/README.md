...
- Package version: 2021.10.0.221102
...
<dependency>
    ...
    <version>2021.10.0.221102</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2021.10.0.221102"
```
...
* `target/criteo-api-marketingsolutions-sdk-2021.10.0.221102.jar`
* `target/lib/*.jar`
