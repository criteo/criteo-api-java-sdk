...
- Package version: 2021.10.0.220926
...
<dependency>
    ...
    <version>2021.10.0.220926</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2021.10.0.220926"
```
...
* `target/criteo-api-marketingsolutions-sdk-2021.10.0.220926.jar`
* `target/lib/*.jar`
