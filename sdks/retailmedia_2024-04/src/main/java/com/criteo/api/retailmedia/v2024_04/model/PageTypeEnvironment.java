...
public class PageTypeEnvironment {
  ...
  **/
   ...
   * @return the PageTypeEnvironment instance itself
   */
  public PageTypeEnvironment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageType, pageTypeEnvironment.pageType) &&
        ...
        Objects.equals(this.additionalProperties, pageTypeEnvironment.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageTypeEnvironment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageTypeEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageTypeEnvironment is not found in the empty JSON string", PageTypeEnvironment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageTypeEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageTypeEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageTypeEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageTypeEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<PageTypeEnvironment>() {
           @Override
           public void write(JsonWriter out, PageTypeEnvironment value) throws IOException {
           ...
           @Override
           public PageTypeEnvironment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PageTypeEnvironment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PageTypeEnvironment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PageTypeEnvironment
  * @throws IOException if the JSON string is invalid with respect to PageTypeEnvironment
  */
  public static PageTypeEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PageTypeEnvironment.class);
  }

 /**
  * Convert an instance of PageTypeEnvironment to an JSON string
  *
  * @return JSON string
  */
