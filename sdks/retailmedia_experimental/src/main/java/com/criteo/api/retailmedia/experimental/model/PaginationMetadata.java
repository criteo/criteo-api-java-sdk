...
public class PaginationMetadata {
  ...
  **/
  ...
  public PaginationMetadata totalCount(Integer totalCount) {
  ...
  **/
   ...
   * @return the PaginationMetadata instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.limit, paginationMetadata.limit) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaginationMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
