...
public class BudgetDetailsModel {
  ...
  public BudgetDetailsModel budget(Double budget) {
  ...
  **/
  ...
  public BudgetDetailsModel dailyPacing(Double dailyPacing) {
  ...
  **/
  ...
  public BudgetDetailsModel isAutoDailyPacing(Boolean isAutoDailyPacing) {
  ...
  **/
  ...
  public BudgetDetailsModel monthlyPacing(Double monthlyPacing) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BudgetDetailsModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BudgetDetailsModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BudgetDetailsModel is not found in the empty JSON string", BudgetDetailsModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BudgetDetailsModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BudgetDetailsModel` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BudgetDetailsModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BudgetDetailsModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BudgetDetailsModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BudgetDetailsModel.class));

       return (TypeAdapter<T>) new TypeAdapter<BudgetDetailsModel>() {
           @Override
           public void write(JsonWriter out, BudgetDetailsModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BudgetDetailsModel read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BudgetDetailsModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BudgetDetailsModel
  * @throws IOException if the JSON string is invalid with respect to BudgetDetailsModel
  */
  public static BudgetDetailsModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BudgetDetailsModel.class);
  }

 /**
  * Convert an instance of BudgetDetailsModel to an JSON string
  *
  * @return JSON string
  */
