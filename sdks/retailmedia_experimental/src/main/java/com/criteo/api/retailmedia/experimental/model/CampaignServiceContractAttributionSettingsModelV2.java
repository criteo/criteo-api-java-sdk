...
/**
 * Wrapper for attribution settings.
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CampaignServiceContractAttributionSettingsModelV2 {
  /**
  ...
  public CampaignServiceContractAttributionSettingsModelV2() {
  }

  public CampaignServiceContractAttributionSettingsModelV2 clickAttributionScope(ClickAttributionScopeEnum clickAttributionScope) {
  ...
  **/
  ...
  public CampaignServiceContractAttributionSettingsModelV2 clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public CampaignServiceContractAttributionSettingsModelV2 viewAttributionScope(ViewAttributionScopeEnum viewAttributionScope) {
  ...
  **/
  ...
  public CampaignServiceContractAttributionSettingsModelV2 viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignServiceContractAttributionSettingsModelV2 campaignServiceContractAttributionSettingsModelV2 = (CampaignServiceContractAttributionSettingsModelV2) o;
    return Objects.equals(this.clickAttributionScope, campaignServiceContractAttributionSettingsModelV2.clickAttributionScope) &&
        Objects.equals(this.clickAttributionWindow, campaignServiceContractAttributionSettingsModelV2.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionScope, campaignServiceContractAttributionSettingsModelV2.viewAttributionScope) &&
        Objects.equals(this.viewAttributionWindow, campaignServiceContractAttributionSettingsModelV2.viewAttributionWindow);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignServiceContractAttributionSettingsModelV2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignServiceContractAttributionSettingsModelV2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignServiceContractAttributionSettingsModelV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignServiceContractAttributionSettingsModelV2 is not found in the empty JSON string", CampaignServiceContractAttributionSettingsModelV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignServiceContractAttributionSettingsModelV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignServiceContractAttributionSettingsModelV2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignServiceContractAttributionSettingsModelV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignServiceContractAttributionSettingsModelV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignServiceContractAttributionSettingsModelV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignServiceContractAttributionSettingsModelV2.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignServiceContractAttributionSettingsModelV2>() {
           @Override
           public void write(JsonWriter out, CampaignServiceContractAttributionSettingsModelV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignServiceContractAttributionSettingsModelV2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignServiceContractAttributionSettingsModelV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignServiceContractAttributionSettingsModelV2
  * @throws IOException if the JSON string is invalid with respect to CampaignServiceContractAttributionSettingsModelV2
  */
  public static CampaignServiceContractAttributionSettingsModelV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignServiceContractAttributionSettingsModelV2.class);
  }

 /**
  * Convert an instance of CampaignServiceContractAttributionSettingsModelV2 to an JSON string
  *
  * @return JSON string
  */
