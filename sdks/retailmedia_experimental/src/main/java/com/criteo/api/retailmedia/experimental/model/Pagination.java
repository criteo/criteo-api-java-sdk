...
/**
 * Pagination of a Line Item search result
 */
...
public class Pagination {
  ...
  public Pagination count(Integer count) {
   ...
   /**
   * Total number of line items matching the search.
   * @return count
  **/
  ...
  public Pagination limit(Integer limit) {
   ...
   /**
   * Maximum size of the paginated result set.
   * @return limit
  **/
  @javax.annotation.Nullable
  ...
  public Pagination offset(Integer offset) {
   ...
   /**
   * Zero based offset for the paginated result set.
   * @return offset
  **/
  @javax.annotation.Nullable
