...
public class AttributionSettingsCreateModel {
  /**
   * Post-click attribution scope setting.
   */
  ...
  /**
   * Post-click attribution window setting.
   */
  ...
  /**
   * Post-view attribution scope setting. Must not be broader than the click attribution scope.
   */
  ...
  /**
   * Post-view attribution window setting. Must not exceed the click attribution window.
   */
  ...
  public AttributionSettingsCreateModel() {
  }

  public AttributionSettingsCreateModel clickAttributionScope(ClickAttributionScopeEnum clickAttributionScope) {
  ...
  **/
  ...
  public AttributionSettingsCreateModel clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public AttributionSettingsCreateModel viewAttributionScope(ViewAttributionScopeEnum viewAttributionScope) {
  ...
  **/
  ...
  public AttributionSettingsCreateModel viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AttributionSettingsCreateModel attributionSettingsCreateModel = (AttributionSettingsCreateModel) o;
    return Objects.equals(this.clickAttributionScope, attributionSettingsCreateModel.clickAttributionScope) &&
        Objects.equals(this.clickAttributionWindow, attributionSettingsCreateModel.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionScope, attributionSettingsCreateModel.viewAttributionScope) &&
        Objects.equals(this.viewAttributionWindow, attributionSettingsCreateModel.viewAttributionWindow);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributionSettingsCreateModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttributionSettingsCreateModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttributionSettingsCreateModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributionSettingsCreateModel is not found in the empty JSON string", AttributionSettingsCreateModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AttributionSettingsCreateModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributionSettingsCreateModel` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributionSettingsCreateModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributionSettingsCreateModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributionSettingsCreateModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributionSettingsCreateModel.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributionSettingsCreateModel>() {
           @Override
           public void write(JsonWriter out, AttributionSettingsCreateModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttributionSettingsCreateModel read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AttributionSettingsCreateModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AttributionSettingsCreateModel
  * @throws IOException if the JSON string is invalid with respect to AttributionSettingsCreateModel
  */
  public static AttributionSettingsCreateModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributionSettingsCreateModel.class);
  }

 /**
  * Convert an instance of AttributionSettingsCreateModel to an JSON string
  *
  * @return JSON string
  */
