...
public class AttributionSettingsModel {
  /**
  ...
  /**
   * Post-view attribution scope setting.
   */
  ...
  /**
   * Post-view attribution window setting.
   */
  ...
  public AttributionSettingsModel() {
  }

  public AttributionSettingsModel clickAttributionScope(ClickAttributionScopeEnum clickAttributionScope) {
  ...
  **/
  ...
  public AttributionSettingsModel clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public AttributionSettingsModel viewAttributionScope(ViewAttributionScopeEnum viewAttributionScope) {
  ...
  **/
  ...
  public AttributionSettingsModel viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AttributionSettingsModel attributionSettingsModel = (AttributionSettingsModel) o;
    return Objects.equals(this.clickAttributionScope, attributionSettingsModel.clickAttributionScope) &&
        Objects.equals(this.clickAttributionWindow, attributionSettingsModel.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionScope, attributionSettingsModel.viewAttributionScope) &&
        Objects.equals(this.viewAttributionWindow, attributionSettingsModel.viewAttributionWindow);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributionSettingsModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttributionSettingsModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttributionSettingsModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributionSettingsModel is not found in the empty JSON string", AttributionSettingsModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AttributionSettingsModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributionSettingsModel` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributionSettingsModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributionSettingsModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributionSettingsModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributionSettingsModel.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributionSettingsModel>() {
           @Override
           public void write(JsonWriter out, AttributionSettingsModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttributionSettingsModel read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AttributionSettingsModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AttributionSettingsModel
  * @throws IOException if the JSON string is invalid with respect to AttributionSettingsModel
  */
  public static AttributionSettingsModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributionSettingsModel.class);
  }

 /**
  * Convert an instance of AttributionSettingsModel to an JSON string
  *
  * @return JSON string
  */
