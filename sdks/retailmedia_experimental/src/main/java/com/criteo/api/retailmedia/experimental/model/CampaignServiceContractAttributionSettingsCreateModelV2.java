...
public class CampaignServiceContractAttributionSettingsCreateModelV2 {
  /**
  ...
  public CampaignServiceContractAttributionSettingsCreateModelV2() {
  }

  public CampaignServiceContractAttributionSettingsCreateModelV2 clickAttributionScope(ClickAttributionScopeEnum clickAttributionScope) {
  ...
  **/
  ...
  public CampaignServiceContractAttributionSettingsCreateModelV2 clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public CampaignServiceContractAttributionSettingsCreateModelV2 viewAttributionScope(ViewAttributionScopeEnum viewAttributionScope) {
  ...
  **/
  ...
  public CampaignServiceContractAttributionSettingsCreateModelV2 viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignServiceContractAttributionSettingsCreateModelV2 campaignServiceContractAttributionSettingsCreateModelV2 = (CampaignServiceContractAttributionSettingsCreateModelV2) o;
    return Objects.equals(this.clickAttributionScope, campaignServiceContractAttributionSettingsCreateModelV2.clickAttributionScope) &&
        Objects.equals(this.clickAttributionWindow, campaignServiceContractAttributionSettingsCreateModelV2.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionScope, campaignServiceContractAttributionSettingsCreateModelV2.viewAttributionScope) &&
        Objects.equals(this.viewAttributionWindow, campaignServiceContractAttributionSettingsCreateModelV2.viewAttributionWindow);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignServiceContractAttributionSettingsCreateModelV2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignServiceContractAttributionSettingsCreateModelV2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignServiceContractAttributionSettingsCreateModelV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignServiceContractAttributionSettingsCreateModelV2 is not found in the empty JSON string", CampaignServiceContractAttributionSettingsCreateModelV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignServiceContractAttributionSettingsCreateModelV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignServiceContractAttributionSettingsCreateModelV2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignServiceContractAttributionSettingsCreateModelV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignServiceContractAttributionSettingsCreateModelV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignServiceContractAttributionSettingsCreateModelV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignServiceContractAttributionSettingsCreateModelV2.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignServiceContractAttributionSettingsCreateModelV2>() {
           @Override
           public void write(JsonWriter out, CampaignServiceContractAttributionSettingsCreateModelV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignServiceContractAttributionSettingsCreateModelV2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignServiceContractAttributionSettingsCreateModelV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignServiceContractAttributionSettingsCreateModelV2
  * @throws IOException if the JSON string is invalid with respect to CampaignServiceContractAttributionSettingsCreateModelV2
  */
  public static CampaignServiceContractAttributionSettingsCreateModelV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignServiceContractAttributionSettingsCreateModelV2.class);
  }

 /**
  * Convert an instance of CampaignServiceContractAttributionSettingsCreateModelV2 to an JSON string
  *
  * @return JSON string
  */
