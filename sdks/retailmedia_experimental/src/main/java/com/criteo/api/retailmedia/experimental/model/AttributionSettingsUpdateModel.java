...
public class AttributionSettingsUpdateModel {
  /**
  ...
  public AttributionSettingsUpdateModel() {
  }

  public AttributionSettingsUpdateModel clickAttributionScope(ClickAttributionScopeEnum clickAttributionScope) {
  ...
  **/
  ...
  public AttributionSettingsUpdateModel clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public AttributionSettingsUpdateModel viewAttributionScope(ViewAttributionScopeEnum viewAttributionScope) {
  ...
  **/
  ...
  public AttributionSettingsUpdateModel viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AttributionSettingsUpdateModel attributionSettingsUpdateModel = (AttributionSettingsUpdateModel) o;
    return Objects.equals(this.clickAttributionScope, attributionSettingsUpdateModel.clickAttributionScope) &&
        Objects.equals(this.clickAttributionWindow, attributionSettingsUpdateModel.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionScope, attributionSettingsUpdateModel.viewAttributionScope) &&
        Objects.equals(this.viewAttributionWindow, attributionSettingsUpdateModel.viewAttributionWindow);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributionSettingsUpdateModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttributionSettingsUpdateModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttributionSettingsUpdateModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributionSettingsUpdateModel is not found in the empty JSON string", AttributionSettingsUpdateModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AttributionSettingsUpdateModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributionSettingsUpdateModel` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributionSettingsUpdateModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributionSettingsUpdateModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributionSettingsUpdateModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributionSettingsUpdateModel.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributionSettingsUpdateModel>() {
           @Override
           public void write(JsonWriter out, AttributionSettingsUpdateModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttributionSettingsUpdateModel read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AttributionSettingsUpdateModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AttributionSettingsUpdateModel
  * @throws IOException if the JSON string is invalid with respect to AttributionSettingsUpdateModel
  */
  public static AttributionSettingsUpdateModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributionSettingsUpdateModel.class);
  }

 /**
  * Convert an instance of AttributionSettingsUpdateModel to an JSON string
  *
  * @return JSON string
  */
