...
public class FlightDates {
  ...
  public FlightDates endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public FlightDates startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endDate, flightDates.endDate) &&
        Objects.equals(this.startDate, flightDates.startDate);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FlightDates
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FlightDates.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FlightDates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlightDates` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
