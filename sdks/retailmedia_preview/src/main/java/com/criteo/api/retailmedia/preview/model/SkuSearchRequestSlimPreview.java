...
public class SkuSearchRequestSlimPreview {
  ...
  **/
  ...
  public SkuSearchRequestSlimPreview addLimitResultsToSkusWithBrandIdsItem(String limitResultsToSkusWithBrandIdsItem) {
    this.limitResultsToSkusWithBrandIds.add(limitResultsToSkusWithBrandIdsItem);
    return this;
  }

   /**
   * A list of brand Id&#39;s to limit the search results to
   * @return limitResultsToSkusWithBrandIds
  **/
  @javax.annotation.Nonnull

  public List<String> getLimitResultsToSkusWithBrandIds() {
    return limitResultsToSkusWithBrandIds;
  }
   ...
   * @return the SkuSearchRequestSlimPreview instance itself
   */
  public SkuSearchRequestSlimPreview putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SkuSearchRequestSlimPreview
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SkuSearchRequestSlimPreview.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SkuSearchRequestSlimPreview is not found in the empty JSON string", SkuSearchRequestSlimPreview.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SkuSearchRequestSlimPreview.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SkuSearchRequestSlimPreview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SkuSearchRequestSlimPreview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SkuSearchRequestSlimPreview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SkuSearchRequestSlimPreview.class));

       return (TypeAdapter<T>) new TypeAdapter<SkuSearchRequestSlimPreview>() {
           @Override
           public void write(JsonWriter out, SkuSearchRequestSlimPreview value) throws IOException {
           ...
           @Override
           public SkuSearchRequestSlimPreview read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SkuSearchRequestSlimPreview instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SkuSearchRequestSlimPreview given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SkuSearchRequestSlimPreview
  * @throws IOException if the JSON string is invalid with respect to SkuSearchRequestSlimPreview
  */
  public static SkuSearchRequestSlimPreview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SkuSearchRequestSlimPreview.class);
  }

 /**
  * Convert an instance of SkuSearchRequestSlimPreview to an JSON string
  *
  * @return JSON string
  */
