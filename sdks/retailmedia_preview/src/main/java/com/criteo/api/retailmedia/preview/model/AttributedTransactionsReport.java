...
public class AttributedTransactionsReport {
  ...
  public AttributedTransactionsReport() {
  }

  public AttributedTransactionsReport campaignIds(List<String> campaignIds) {
    
    this.campaignIds = campaignIds;
    return this;
  }

  public AttributedTransactionsReport addCampaignIdsItem(String campaignIdsItem) {
  ...
  **/
  ...
  public AttributedTransactionsReport lineItemIds(List<String> lineItemIds) {
    
    this.lineItemIds = lineItemIds;
    return this;
  }

  public AttributedTransactionsReport addLineItemIdsItem(String lineItemIdsItem) {
  ...
  **/
  ...
  public AttributedTransactionsReport dimensions(List<DimensionsEnum> dimensions) {
    
    this.dimensions = dimensions;
    return this;
  }

  public AttributedTransactionsReport addDimensionsItem(DimensionsEnum dimensionsItem) {
  ...
  **/
  ...
  public AttributedTransactionsReport metrics(List<MetricsEnum> metrics) {
    
    this.metrics = metrics;
    return this;
  }

  public AttributedTransactionsReport addMetricsItem(MetricsEnum metricsItem) {
  ...
  **/
  ...
  public AttributedTransactionsReport soldBy(SoldByEnum soldBy) {
  ...
  **/
  ...
  public AttributedTransactionsReport campaignSubType(CampaignSubTypeEnum campaignSubType) {
  ...
  **/
  ...
  public AttributedTransactionsReport accountId(String accountId) {
  ...
  **/
  ...
  public AttributedTransactionsReport startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public AttributedTransactionsReport endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public AttributedTransactionsReport timezone(String timezone) {
  ...
  **/
  ...
  public AttributedTransactionsReport clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public AttributedTransactionsReport viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
   ...
   * @return the AttributedTransactionsReport instance itself
   */
  public AttributedTransactionsReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AttributedTransactionsReport attributedTransactionsReport = (AttributedTransactionsReport) o;
    return Objects.equals(this.campaignIds, attributedTransactionsReport.campaignIds) &&
        Objects.equals(this.lineItemIds, attributedTransactionsReport.lineItemIds) &&
        Objects.equals(this.dimensions, attributedTransactionsReport.dimensions) &&
        Objects.equals(this.metrics, attributedTransactionsReport.metrics) &&
        Objects.equals(this.soldBy, attributedTransactionsReport.soldBy) &&
        Objects.equals(this.campaignSubType, attributedTransactionsReport.campaignSubType) &&
        Objects.equals(this.accountId, attributedTransactionsReport.accountId) &&
        Objects.equals(this.startDate, attributedTransactionsReport.startDate) &&
        Objects.equals(this.endDate, attributedTransactionsReport.endDate) &&
        Objects.equals(this.timezone, attributedTransactionsReport.timezone) &&
        Objects.equals(this.clickAttributionWindow, attributedTransactionsReport.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionWindow, attributedTransactionsReport.viewAttributionWindow)&&
        Objects.equals(this.additionalProperties, attributedTransactionsReport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignIds, lineItemIds, dimensions, metrics, soldBy, campaignSubType, accountId, startDate, endDate, timezone, clickAttributionWindow, viewAttributionWindow, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AttributedTransactionsReport {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttributedTransactionsReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttributedTransactionsReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributedTransactionsReport is not found in the empty JSON string", AttributedTransactionsReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttributedTransactionsReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributedTransactionsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributedTransactionsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributedTransactionsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributedTransactionsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributedTransactionsReport>() {
           @Override
           public void write(JsonWriter out, AttributedTransactionsReport value) throws IOException {
           ...
           @Override
           public AttributedTransactionsReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AttributedTransactionsReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AttributedTransactionsReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AttributedTransactionsReport
  * @throws IOException if the JSON string is invalid with respect to AttributedTransactionsReport
  */
  public static AttributedTransactionsReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributedTransactionsReport.class);
  }

 /**
  * Convert an instance of AttributedTransactionsReport to an JSON string
  *
  * @return JSON string
  */
