...
public class AttributedTransactionsReport {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(campaignIds, lineItemIds, dimensions, metrics, accountId, startDate, endDate, timezone, clickAttributionWindow, viewAttributionWindow, additionalProperties);
  }
