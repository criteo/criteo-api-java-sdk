...
public class CampaignAttributionRequest {
  /**
   * The attribution scope for clicks, defining the level at which click attributions are tracked.
   */
  ...
  /**
   * The attribution window for clicks, defining how long after a click a conversion can be attributed to it.
   */
  ...
  /**
   * The attribution scope for views, defining the level at which view attributions are tracked.
   */
  ...
  /**
   * The attribution window for views, defining how long after an ad view a conversion can be attributed to it.
   */
  ...
  public CampaignAttributionRequest() {
  }

  public CampaignAttributionRequest clickAttributionScope(ClickAttributionScopeEnum clickAttributionScope) {
  ...
  **/
  ...
  public CampaignAttributionRequest clickAttributionWindow(ClickAttributionWindowEnum clickAttributionWindow) {
  ...
  **/
  ...
  public CampaignAttributionRequest viewAttributionScope(ViewAttributionScopeEnum viewAttributionScope) {
  ...
  **/
  ...
  public CampaignAttributionRequest viewAttributionWindow(ViewAttributionWindowEnum viewAttributionWindow) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignAttributionRequest campaignAttributionRequest = (CampaignAttributionRequest) o;
    return Objects.equals(this.clickAttributionScope, campaignAttributionRequest.clickAttributionScope) &&
        Objects.equals(this.clickAttributionWindow, campaignAttributionRequest.clickAttributionWindow) &&
        Objects.equals(this.viewAttributionScope, campaignAttributionRequest.viewAttributionScope) &&
        Objects.equals(this.viewAttributionWindow, campaignAttributionRequest.viewAttributionWindow);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignAttributionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignAttributionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignAttributionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignAttributionRequest is not found in the empty JSON string", CampaignAttributionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CampaignAttributionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignAttributionRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignAttributionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignAttributionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignAttributionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignAttributionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignAttributionRequest>() {
           @Override
           public void write(JsonWriter out, CampaignAttributionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignAttributionRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignAttributionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignAttributionRequest
  * @throws IOException if the JSON string is invalid with respect to CampaignAttributionRequest
  */
  public static CampaignAttributionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignAttributionRequest.class);
  }

 /**
  * Convert an instance of CampaignAttributionRequest to an JSON string
  *
  * @return JSON string
  */
