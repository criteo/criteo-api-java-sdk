...
public class SyncAttributedTransactionsReport {
  ...
  public SyncAttributedTransactionsReport addCampaignIdsItem(String campaignIdsItem) {
  ...
  **/
  ...
  public SyncAttributedTransactionsReport dimensions(List<DimensionsEnum> dimensions) {
    
    this.dimensions = dimensions;
    return this;
  }

  public SyncAttributedTransactionsReport addDimensionsItem(DimensionsEnum dimensionsItem) {
  ...
  **/
  ...
  public SyncAttributedTransactionsReport addMetricsItem(MetricsEnum metricsItem) {
  ...
  **/
   ...
   * @return the SyncAttributedTransactionsReport instance itself
   */
  public SyncAttributedTransactionsReport putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(campaignIds, lineItemIds, dimensions, metrics, accountId, clickAttributionWindow, viewAttributionWindow, campaignType, salesChannel, startDate, endDate, timezone, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncAttributedTransactionsReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncAttributedTransactionsReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncAttributedTransactionsReport is not found in the empty JSON string", SyncAttributedTransactionsReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyncAttributedTransactionsReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncAttributedTransactionsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncAttributedTransactionsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncAttributedTransactionsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncAttributedTransactionsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncAttributedTransactionsReport>() {
           @Override
           public void write(JsonWriter out, SyncAttributedTransactionsReport value) throws IOException {
           ...
           @Override
           public SyncAttributedTransactionsReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncAttributedTransactionsReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncAttributedTransactionsReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncAttributedTransactionsReport
  * @throws IOException if the JSON string is invalid with respect to SyncAttributedTransactionsReport
  */
  public static SyncAttributedTransactionsReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncAttributedTransactionsReport.class);
  }

 /**
  * Convert an instance of SyncAttributedTransactionsReport to an JSON string
  *
  * @return JSON string
  */
