...
import com.criteo.api.retailmedia.preview.model.AddFundsToBalanceRequest;
import com.criteo.api.retailmedia.preview.model.BalanceResponse;
import com.criteo.api.retailmedia.preview.model.BalanceResponsePagedListResponse;
import com.criteo.api.retailmedia.preview.model.BrandPreviewListResponse;
import com.criteo.api.retailmedia.preview.model.ChangeDatesOfBalanceRequest;
import com.criteo.api.retailmedia.preview.model.CpcRateCardPreviewResponse;
import com.criteo.api.retailmedia.preview.model.CreateBalanceRequest;
...
import com.criteo.api.retailmedia.preview.model.UpdateBalanceModelRequest;
import com.criteo.api.retailmedia.preview.model.ValueResourceOutcomeOfCampaignBudgetOverrides;
import com.criteo.api.retailmedia.preview.model.ValueResourceOutcomeOfSuggestedKeywordsResult;
...
public class CampaignApi {
    ...
    public okhttp3.Call getApiV1ExternalAccountByAccountIdAndBalanceIdCall(String accountId, String balanceId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/preview/retail-media/accounts/{accountId}/balances/{balanceId}"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()))
    ...
    /**
     * Build call for getSuggestedKeywords
     ...
     */
    public okhttp3.Call getSuggestedKeywordsCall(String externalLineItemId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSuggestedKeywordsValidateBeforeCall(String externalLineItemId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'externalLineItemId' is set
        if (externalLineItemId == null) {
            throw new ApiException("Missing the required parameter 'externalLineItemId' when calling getSuggestedKeywords(Async)");
        }

        return getSuggestedKeywordsCall(externalLineItemId, _callback);
     ...
     * @param externalLineItemId The external line item identifier (required)
     * @return ValueResourceOutcomeOfSuggestedKeywordsResult
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ValueResourceOutcomeOfSuggestedKeywordsResult getSuggestedKeywords(String externalLineItemId) throws ApiException {
        ApiResponse<ValueResourceOutcomeOfSuggestedKeywordsResult> localVarResp = getSuggestedKeywordsWithHttpInfo(externalLineItemId);
        return localVarResp.getData();
    }
     ...
     * Retrieves a collection of recommended keywords for a line item
     * @param externalLineItemId The external line item identifier (required)
     * @return ApiResponse&lt;ValueResourceOutcomeOfSuggestedKeywordsResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ValueResourceOutcomeOfSuggestedKeywordsResult> getSuggestedKeywordsWithHttpInfo(String externalLineItemId) throws ApiException {
        okhttp3.Call localVarCall = getSuggestedKeywordsValidateBeforeCall(externalLineItemId, null);
        Type localVarReturnType = new TypeToken<ValueResourceOutcomeOfSuggestedKeywordsResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getSuggestedKeywordsAsync(String externalLineItemId, final ApiCallback<ValueResourceOutcomeOfSuggestedKeywordsResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSuggestedKeywordsValidateBeforeCall(externalLineItemId, _callback);
        Type localVarReturnType = new TypeToken<ValueResourceOutcomeOfSuggestedKeywordsResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call postApiV1ExternalAccountAddFundsByAccountIdAndBalanceIdCall(String accountId, String balanceId, AddFundsToBalanceRequest addFundsToBalanceRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/preview/retail-media/accounts/{accountId}/balances/{balanceId}/add-funds"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()))
            .replace("{" + "balanceId" + "}", localVarApiClient.escapeString(balanceId.toString()));
    ...
    public okhttp3.Call postApiV1ExternalAccountChangeDatesByAccountIdAndBalanceIdCall(String accountId, String balanceId, ChangeDatesOfBalanceRequest changeDatesOfBalanceRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/preview/retail-media/accounts/{accountId}/balances/{balanceId}/change-dates"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()))
            .replace("{" + "balanceId" + "}", localVarApiClient.escapeString(balanceId.toString()));
