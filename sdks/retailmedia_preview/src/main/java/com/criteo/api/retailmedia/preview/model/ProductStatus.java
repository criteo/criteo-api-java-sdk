...
public class ProductStatus {
  ...
  **/
  ...
  public ProductStatus retailerComment(String retailerComment) {
   ...
   /**
   * The retailer&#39;s comment on this product. One comment applies to all products in the line item.
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.productId, productStatus.productId) &&
        Objects.equals(this.retailerComment, productStatus.retailerComment) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productId, retailerComment, status);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProductStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
