...
public class PlacementPreview {
  ...
  public PlacementPreview id(String id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, placementPreview.id) &&
        Objects.equals(this.name, placementPreview.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, pageEnvironmentType, pageType, retailerId);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PlacementPreview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlacementPreview` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
