...
> EntityResourceCollectionOutcomeOfRetailMediaAccount getApiExternalV1AccountPrivateMarketChildAccountsByAccountId(accountId, offset, limit)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            EntityResourceCollectionOutcomeOfRetailMediaAccount result = apiInstance.getApiExternalV1AccountPrivateMarketChildAccountsByAccountId(accountId, offset, limit);
            System.out.println(result);
        } catch (ApiException e) {
