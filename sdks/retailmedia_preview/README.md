...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:0.0.260901"
```
...
* `build/libs/criteo-api-retailmedia-sdk-0.0.260901.jar`
...
*AnalyticsApi* | [**getInsightReportOutput**](docs/AnalyticsApi.md#getInsightReportOutput) | **GET** /preview/retail-media/insights/{insight-id}/output | /preview/retail-media/insights/{insight-id}/output
*AnalyticsApi* | [**getInsightReportStatus**](docs/AnalyticsApi.md#getInsightReportStatus) | **GET** /preview/retail-media/insights/{insight-id}/status | /preview/retail-media/insights/{insight-id}/status
