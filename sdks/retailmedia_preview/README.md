...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:0.0.251028"
```
...
* `build/libs/criteo-api-retailmedia-sdk-0.0.251028.jar`
...
*AudienceApi* | [**deleteContactListByAudienceSegment**](docs/AudienceApi.md#deleteContactListByAudienceSegment) | **POST** /preview/retail-media/audience-segments/{audience-segment-id}/contact-list/clear | 
...
*AudienceApi* | [**updateContactListByAudienceSegment**](docs/AudienceApi.md#updateContactListByAudienceSegment) | **POST** /preview/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove | 
