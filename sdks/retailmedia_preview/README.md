...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:0.0.230427"
```
...
* `target/criteo-api-retailmedia-sdk-0.0.230427.jar`
* `target/lib/*.jar`
...
------------ | ------------- | ------------- | -------------
*AnalyticsApi* | [**getCampaignReports**](docs/AnalyticsApi.md#getCampaignReports) | **POST** /preview/retail-media/reports/sync/campaigns | 
*AnalyticsApi* | [**getLineItemsReports**](docs/AnalyticsApi.md#getLineItemsReports) | **POST** /preview/retail-media/reports/sync/line-items | 
