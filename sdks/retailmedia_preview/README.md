...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:0.0.260415"
```
...
* `build/libs/criteo-api-retailmedia-sdk-0.0.260415.jar`
...
*AnalyticsApi* | [**generateShareOfVoiceInsight**](docs/AnalyticsApi.md#generateShareOfVoiceInsight) | **POST** /preview/retail-media/insights/share-of-voice | 
...
*AnalyticsApi* | [**generateSyncRealTimePerformanceReport**](docs/AnalyticsApi.md#generateSyncRealTimePerformanceReport) | **POST** /preview/retail-media/reports/sync/real-time-performance | 
...
*BalanceApi* | [**getBalanceHistoryV1**](docs/BalanceApi.md#getBalanceHistoryV1) | **GET** /preview/retail-media/balances/{balanceId}/history | 
*BalanceApi* | [**getBalanceV1**](docs/BalanceApi.md#getBalanceV1) | **GET** /preview/retail-media/balances/{balanceId} | 
*BalanceApi* | [**getPageOfBalancesV1**](docs/BalanceApi.md#getPageOfBalancesV1) | **GET** /preview/retail-media/accounts/{accountId}/balances | 
*BalanceApi* | [**updateBalanceV1**](docs/BalanceApi.md#updateBalanceV1) | **PATCH** /preview/retail-media/accounts/{account-id}/balances/{balance-id} | 
*CampaignApi* | [**appendCampaignsToBalanceV1**](docs/CampaignApi.md#appendCampaignsToBalanceV1) | **POST** /preview/retail-media/balances/{balanceId}/campaigns/append | 
...
*CampaignApi* | [**createAuctionDisplayLineItem**](docs/CampaignApi.md#createAuctionDisplayLineItem) | **POST** /preview/retail-media/campaigns/{campaignId}/auction-display-line-items | 
*CampaignApi* | [**createAuctionLineItem**](docs/CampaignApi.md#createAuctionLineItem) | **POST** /preview/retail-media/campaigns/{campaignId}/auction-line-items | 
*CampaignApi* | [**createCreative**](docs/CampaignApi.md#createCreative) | **POST** /preview/retail-media/accounts/{account-id}/creatives | 
*CampaignApi* | [**createDisplayCampaign**](docs/CampaignApi.md#createDisplayCampaign) | **POST** /preview/retail-media/accounts/{accountId}/display-campaigns | 
...
*CampaignApi* | [**deleteCampaignsFromBalanceV1**](docs/CampaignApi.md#deleteCampaignsFromBalanceV1) | **POST** /preview/retail-media/balances/{balanceId}/campaigns/delete | 
...
*CampaignApi* | [**getAuctionLineItem**](docs/CampaignApi.md#getAuctionLineItem) | **GET** /preview/retail-media/auction-line-items/{lineItemId} | 
*CampaignApi* | [**getAuctionLineItemsByCampaign**](docs/CampaignApi.md#getAuctionLineItemsByCampaign) | **GET** /preview/retail-media/campaigns/{campaignId}/auction-line-items | 
...
*CampaignApi* | [**getCatalogStatus**](docs/CampaignApi.md#getCatalogStatus) | **GET** /preview/retail-media/catalogs/{catalogId}/status | 
...
*CampaignApi* | [**recallProposal**](docs/CampaignApi.md#recallProposal) | **POST** /preview/retail-media/auction-display-line-items/{lineItemId}/recall-proposal | 
...
*CampaignApi* | [**searchAccountRetailers**](docs/CampaignApi.md#searchAccountRetailers) | **POST** /preview/retail-media/accounts/{accountId}/retailers/search | 
*CampaignApi* | [**searchAuctionDisplayLineItems**](docs/CampaignApi.md#searchAuctionDisplayLineItems) | **POST** /preview/retail-media/accounts/{accountId}/auction-display-line-items/search | 
*CampaignApi* | [**searchBrands**](docs/CampaignApi.md#searchBrands) | **POST** /preview/retail-media/brands/search | 
*CampaignApi* | [**searchDisplayCampaigns**](docs/CampaignApi.md#searchDisplayCampaigns) | **POST** /preview/retail-media/accounts/{accountId}/display-campaigns/search | 
*CampaignApi* | [**submitProposal**](docs/CampaignApi.md#submitProposal) | **POST** /preview/retail-media/auction-display-line-items/{lineItemId}/submit-proposal | 
...
*CampaignApi* | [**updateAuctionDisplayLineItem**](docs/CampaignApi.md#updateAuctionDisplayLineItem) | **PATCH** /preview/retail-media/auction-display-line-items/{lineItemId} | 
*CampaignApi* | [**updateAuctionLineItem**](docs/CampaignApi.md#updateAuctionLineItem) | **PUT** /preview/retail-media/auction-line-items/{lineItemId} | 
...
*CampaignApi* | [**updateDisplayCampaign**](docs/CampaignApi.md#updateDisplayCampaign) | **PATCH** /preview/retail-media/display-campaigns/{campaignId} | 
...
*CatalogApi* | [**deleteStoreInventoryPerMerchantId**](docs/CatalogApi.md#deleteStoreInventoryPerMerchantId) | **POST** /preview/retail-media/catalog/merchants/{merchantId}/store-inventory/delete | 
*CatalogApi* | [**getCatalogProductsBatchReport**](docs/CatalogApi.md#getCatalogProductsBatchReport) | **GET** /preview/retail-media/catalog/products/batch/report/{operation-token} | 
*CatalogApi* | [**offerSetBbwV1**](docs/CatalogApi.md#offerSetBbwV1) | **POST** /preview/retail-media/retailers/{retailer-id}/products/set-buy-box-winners | 
*CatalogApi* | [**offerUpdateV1**](docs/CatalogApi.md#offerUpdateV1) | **POST** /preview/retail-media/retailers/{retailer-id}/offers/update | 
*CatalogApi* | [**submitCatalogProductsBatch**](docs/CatalogApi.md#submitCatalogProductsBatch) | **POST** /preview/retail-media/catalog/products/batch | 
*CatalogApi* | [**upsertStoreInventoryPerMerchantId**](docs/CatalogApi.md#upsertStoreInventoryPerMerchantId) | **POST** /preview/retail-media/catalog/merchants/{merchantId}/store-inventory/upsert | 
...
*ThirdPartyAccountsApi* | [**addThirdPartyAccountBrands**](docs/ThirdPartyAccountsApi.md#addThirdPartyAccountBrands) | **POST** /preview/retail-media/third-party-accounts/{accountId}/brands/add | 
*ThirdPartyAccountsApi* | [**createThirdPartyBrandAccount**](docs/ThirdPartyAccountsApi.md#createThirdPartyBrandAccount) | **POST** /preview/retail-media/third-party-accounts/{accountId}/create-brand-account | 
*ThirdPartyAccountsApi* | [**createThirdPartySellerAccount**](docs/ThirdPartyAccountsApi.md#createThirdPartySellerAccount) | **POST** /preview/retail-media/third-party-accounts/{accountId}/create-seller-account | 
...
*ThirdPartyAccountsApi* | [**removeThirdPartyAccountBrand**](docs/ThirdPartyAccountsApi.md#removeThirdPartyAccountBrand) | **POST** /preview/retail-media/third-party-accounts/{accountId}/brands/{brandId}/remove | 
*ThirdPartyAccountsApi* | [**updateThirdPartyAccountSellers**](docs/ThirdPartyAccountsApi.md#updateThirdPartyAccountSellers) | **PUT** /preview/retail-media/third-party-accounts/{accountId}/sellers | 
...
## Documentation for Models
 ...
 - [AuctionBid](docs/AuctionBid.md)
 - [AuctionBidRequest](docs/AuctionBidRequest.md)
 - [AuctionDisplayLineItem](docs/AuctionDisplayLineItem.md)
 - [AuctionDisplayLineItemCreateModel](docs/AuctionDisplayLineItemCreateModel.md)
 - [AuctionDisplayLineItemPatchModel](docs/AuctionDisplayLineItemPatchModel.md)
 - [AuctionDisplayLineItemRecallProposalRequest](docs/AuctionDisplayLineItemRecallProposalRequest.md)
 - [AuctionDisplayLineItemSearchModel](docs/AuctionDisplayLineItemSearchModel.md)
 - [AuctionDisplayLineItemSearchResult](docs/AuctionDisplayLineItemSearchResult.md)
 - [AuctionDisplayLineItemSubmitProposalRequest](docs/AuctionDisplayLineItemSubmitProposalRequest.md)
 ...
 - [BiddingRequest](docs/BiddingRequest.md)
 ...
 - [CampaignAttribution](docs/CampaignAttribution.md)
 - [CampaignAttributionRequest](docs/CampaignAttributionRequest.md)
 - [CampaignAvailability](docs/CampaignAvailability.md)
 - [CampaignCappingTarget](docs/CampaignCappingTarget.md)
 - [CampaignCappingTargetRequest](docs/CampaignCappingTargetRequest.md)
 ...
 - [DisplayCampaign](docs/DisplayCampaign.md)
 - [DisplayCampaignCreateModel](docs/DisplayCampaignCreateModel.md)
 - [DisplayCampaignPatchModel](docs/DisplayCampaignPatchModel.md)
 - [DisplayCampaignSearchModel](docs/DisplayCampaignSearchModel.md)
 ...
 - [EntityResourceCollectionOutcomeOfAuctionDisplayLineItemSearchResultAndMetadata](docs/EntityResourceCollectionOutcomeOfAuctionDisplayLineItemSearchResultAndMetadata.md)
 - [EntityResourceCollectionOutcomeOfDisplayCampaignAndMetadata](docs/EntityResourceCollectionOutcomeOfDisplayCampaignAndMetadata.md)
 ...
 - [EntityResourceInputOfAuctionDisplayLineItemRecallProposalRequest](docs/EntityResourceInputOfAuctionDisplayLineItemRecallProposalRequest.md)
 - [EntityResourceInputOfAuctionDisplayLineItemSubmitProposalRequest](docs/EntityResourceInputOfAuctionDisplayLineItemSubmitProposalRequest.md)
 - [EntityResourceOfAuctionDisplayLineItem](docs/EntityResourceOfAuctionDisplayLineItem.md)
 - [EntityResourceOfAuctionDisplayLineItemRecallProposalRequest](docs/EntityResourceOfAuctionDisplayLineItemRecallProposalRequest.md)
 - [EntityResourceOfAuctionDisplayLineItemSearchResult](docs/EntityResourceOfAuctionDisplayLineItemSearchResult.md)
 - [EntityResourceOfAuctionDisplayLineItemSubmitProposalRequest](docs/EntityResourceOfAuctionDisplayLineItemSubmitProposalRequest.md)
 - [EntityResourceOfCatalogStatusV2](docs/EntityResourceOfCatalogStatusV2.md)
 - [EntityResourceOfDisplayCampaign](docs/EntityResourceOfDisplayCampaign.md)
 ...
 - [EntityResourceOutcomeOfAuctionDisplayLineItem](docs/EntityResourceOutcomeOfAuctionDisplayLineItem.md)
 - [EntityResourceOutcomeOfCatalogStatusV2](docs/EntityResourceOutcomeOfCatalogStatusV2.md)
 - [EntityResourceOutcomeOfDisplayCampaign](docs/EntityResourceOutcomeOfDisplayCampaign.md)
 ...
 - [LineItemCappingTarget](docs/LineItemCappingTarget.md)
 - [LineItemCappingTargetRequest](docs/LineItemCappingTargetRequest.md)
 - [LineItemCappingV2](docs/LineItemCappingV2.md)
 - [LineItemPacing](docs/LineItemPacing.md)
 - [LineItemPacingRequest](docs/LineItemPacingRequest.md)
 ...
 - [ManualBidding](docs/ManualBidding.md)
 - [ManualBiddingRequest](docs/ManualBiddingRequest.md)
 ...
 - [NillableOfCampaignCappingTargetRequest](docs/NillableOfCampaignCappingTargetRequest.md)
 - [NillableOfLineItemCappingTargetRequest](docs/NillableOfLineItemCappingTargetRequest.md)
 ...
 - [ServedCategoryFilter](docs/ServedCategoryFilter.md)
 ...
 - [ValueResourceInputOfAuctionDisplayLineItemCreateModel](docs/ValueResourceInputOfAuctionDisplayLineItemCreateModel.md)
 - [ValueResourceInputOfAuctionDisplayLineItemPatchModel](docs/ValueResourceInputOfAuctionDisplayLineItemPatchModel.md)
 - [ValueResourceInputOfAuctionDisplayLineItemSearchModel](docs/ValueResourceInputOfAuctionDisplayLineItemSearchModel.md)
 - [ValueResourceInputOfDisplayCampaignCreateModel](docs/ValueResourceInputOfDisplayCampaignCreateModel.md)
 - [ValueResourceInputOfDisplayCampaignPatchModel](docs/ValueResourceInputOfDisplayCampaignPatchModel.md)
 - [ValueResourceInputOfDisplayCampaignSearchModel](docs/ValueResourceInputOfDisplayCampaignSearchModel.md)
 ...
 - [ValueResourceOfAuctionDisplayLineItemCreateModel](docs/ValueResourceOfAuctionDisplayLineItemCreateModel.md)
 - [ValueResourceOfAuctionDisplayLineItemPatchModel](docs/ValueResourceOfAuctionDisplayLineItemPatchModel.md)
 - [ValueResourceOfAuctionDisplayLineItemSearchModel](docs/ValueResourceOfAuctionDisplayLineItemSearchModel.md)
 - [ValueResourceOfDisplayCampaignCreateModel](docs/ValueResourceOfDisplayCampaignCreateModel.md)
 - [ValueResourceOfDisplayCampaignPatchModel](docs/ValueResourceOfDisplayCampaignPatchModel.md)
 - [ValueResourceOfDisplayCampaignSearchModel](docs/ValueResourceOfDisplayCampaignSearchModel.md)
