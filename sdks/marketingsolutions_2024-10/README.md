# JAVA SDK for Criteo API marketingsolutions for 2024_10 version
...
```groovy
compile "com.criteo:criteo-api-marketingsolutions-sdk:2024.10.0.260112"
```
...
* `build/libs/criteo-api-marketingsolutions-sdk-2024.10.0.260112.jar`
...
------------ | ------------- | ------------- | -------------
*AdvertiserApi* | [**listAdvertisers**](docs/AdvertiserApi.md#listAdvertisers) | **GET** /2024-10/advertisers/me | 
...
*AudienceApi* | [**createAudienceSegments**](docs/AudienceApi.md#createAudienceSegments) | **POST** /2024-10/marketing-solutions/audience-segments/create | 
*AudienceApi* | [**createAudiences**](docs/AudienceApi.md#createAudiences) | **POST** /2024-10/marketing-solutions/audiences/create | 
*AudienceApi* | [**deleteAudienceSegments**](docs/AudienceApi.md#deleteAudienceSegments) | **POST** /2024-10/marketing-solutions/audience-segments/delete | 
*AudienceApi* | [**deleteAudiences**](docs/AudienceApi.md#deleteAudiences) | **POST** /2024-10/marketing-solutions/audiences/delete | 
*AudienceApi* | [**estimateAudienceSegmentsSizes**](docs/AudienceApi.md#estimateAudienceSegmentsSizes) | **POST** /2024-10/marketing-solutions/audience-segments/estimate-size | 
*AudienceApi* | [**estimateAudiencesSizes**](docs/AudienceApi.md#estimateAudiencesSizes) | **POST** /2024-10/marketing-solutions/audiences/estimate-size | 
...
*AudienceApi* | [**updateAudienceSegments**](docs/AudienceApi.md#updateAudienceSegments) | **PATCH** /2024-10/marketing-solutions/audience-segments | 
*AudienceApi* | [**updateAudiences**](docs/AudienceApi.md#updateAudiences) | **PATCH** /2024-10/marketing-solutions/audiences | 
*CampaignApi* | [**createAdSet**](docs/CampaignApi.md#createAdSet) | **POST** /2024-10/marketing-solutions/ad-sets | 
*CampaignApi* | [**createCampaign**](docs/CampaignApi.md#createCampaign) | **POST** /2024-10/marketing-solutions/campaigns | 
*CampaignApi* | [**getAdSet**](docs/CampaignApi.md#getAdSet) | **GET** /2024-10/marketing-solutions/ad-sets/{ad-set-id} | 
*CampaignApi* | [**getAdSetCategoryBids**](docs/CampaignApi.md#getAdSetCategoryBids) | **GET** /2024-10/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
*CampaignApi* | [**getCampaign**](docs/CampaignApi.md#getCampaign) | **GET** /2024-10/marketing-solutions/campaigns/{campaign-id} | 
...
*CampaignApi* | [**patchAdSetCategoryBids**](docs/CampaignApi.md#patchAdSetCategoryBids) | **PATCH** /2024-10/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
*CampaignApi* | [**patchAdSets**](docs/CampaignApi.md#patchAdSets) | **PATCH** /2024-10/marketing-solutions/ad-sets | 
...
*CampaignApi* | [**searchAdSets**](docs/CampaignApi.md#searchAdSets) | **POST** /2024-10/marketing-solutions/ad-sets/search | 
*CampaignApi* | [**searchCampaigns**](docs/CampaignApi.md#searchCampaigns) | **POST** /2024-10/marketing-solutions/campaigns/search | 
...
*CreativeApi* | [**getAdvertiserAds**](docs/CreativeApi.md#getAdvertiserAds) | **GET** /2024-10/marketing-solutions/advertisers/{advertiser-id}/ads | 
