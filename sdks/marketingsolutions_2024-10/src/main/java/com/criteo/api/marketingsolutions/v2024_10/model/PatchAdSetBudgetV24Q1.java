...
public class PatchAdSetBudgetV24Q1 {
  ...
  **/
  ...
  public PatchAdSetBudgetV24Q1 budgetDeliverySmoothing(BudgetDeliverySmoothingEnum budgetDeliverySmoothing) {
  ...
  **/
  ...
  public PatchAdSetBudgetV24Q1 budgetDeliveryWeek(BudgetDeliveryWeekEnum budgetDeliveryWeek) {
  ...
  **/
   ...
   * @return the PatchAdSetBudgetV24Q1 instance itself
   */
  public PatchAdSetBudgetV24Q1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchAdSetBudgetV24Q1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchAdSetBudgetV24Q1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchAdSetBudgetV24Q1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchAdSetBudgetV24Q1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchAdSetBudgetV24Q1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchAdSetBudgetV24Q1.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchAdSetBudgetV24Q1>() {
           @Override
           public void write(JsonWriter out, PatchAdSetBudgetV24Q1 value) throws IOException {
           ...
           @Override
           public PatchAdSetBudgetV24Q1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchAdSetBudgetV24Q1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchAdSetBudgetV24Q1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchAdSetBudgetV24Q1
  * @throws IOException if the JSON string is invalid with respect to PatchAdSetBudgetV24Q1
  */
  public static PatchAdSetBudgetV24Q1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchAdSetBudgetV24Q1.class);
  }

 /**
  * Convert an instance of PatchAdSetBudgetV24Q1 to an JSON string
  *
  * @return JSON string
  */
