...
import com.criteo.api.marketingsolutions.v2024_10.model.NillableString;
...
public class AudienceUpdateEntityV1 {
  ...
  **/
   ...
   * @return the AudienceUpdateEntityV1 instance itself
   */
  public AudienceUpdateEntityV1 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AudienceUpdateEntityV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AudienceUpdateEntityV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudienceUpdateEntityV1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudienceUpdateEntityV1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudienceUpdateEntityV1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudienceUpdateEntityV1.class));

       return (TypeAdapter<T>) new TypeAdapter<AudienceUpdateEntityV1>() {
           @Override
           public void write(JsonWriter out, AudienceUpdateEntityV1 value) throws IOException {
           ...
           @Override
           public AudienceUpdateEntityV1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AudienceUpdateEntityV1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AudienceUpdateEntityV1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AudienceUpdateEntityV1
  * @throws IOException if the JSON string is invalid with respect to AudienceUpdateEntityV1
  */
  public static AudienceUpdateEntityV1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudienceUpdateEntityV1.class);
  }

 /**
  * Convert an instance of AudienceUpdateEntityV1 to an JSON string
  *
  * @return JSON string
  */
