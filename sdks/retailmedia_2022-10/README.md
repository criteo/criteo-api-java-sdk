...
- Package version: 2022.10.0.230728
...
<dependency>
    ...
    <version>2022.10.0.230728</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.230728"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.230728.jar`
* `target/lib/*.jar`
