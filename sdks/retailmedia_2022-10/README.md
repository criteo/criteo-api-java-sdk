...
- Package version: 2022.10.0.230324
...
<dependency>
    ...
    <version>2022.10.0.230324</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.230324"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.230324.jar`
* `target/lib/*.jar`
