...
- Package version: 2022.10.0.230216
...
<dependency>
    ...
    <version>2022.10.0.230216</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.230216"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.230216.jar`
* `target/lib/*.jar`
