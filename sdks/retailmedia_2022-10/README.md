...
- Package version: 2022.10.0.230726
...
<dependency>
    ...
    <version>2022.10.0.230726</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.230726"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.230726.jar`
* `target/lib/*.jar`
