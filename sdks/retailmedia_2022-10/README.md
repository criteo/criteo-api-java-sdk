...
- Package version: 2022.10.0.230323
...
<dependency>
    ...
    <version>2022.10.0.230323</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.230323"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.230323.jar`
* `target/lib/*.jar`
