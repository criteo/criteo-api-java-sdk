...
- Package version: 2022.10.0.221026
...
<dependency>
    ...
    <version>2022.10.0.221026</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.221026"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.221026.jar`
* `target/lib/*.jar`
