...
- Package version: 2022.10.0.230331
...
<dependency>
    ...
    <version>2022.10.0.230331</version>
    <scope>compile</scope>
</dependency>
```
...
```groovy
compile "com.criteo:criteo-api-retailmedia-sdk:2022.10.0.230331"
```
...
* `target/criteo-api-retailmedia-sdk-2022.10.0.230331.jar`
* `target/lib/*.jar`
