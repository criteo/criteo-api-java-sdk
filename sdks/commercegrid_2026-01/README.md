...
```groovy
compile "com.criteo:criteo-api-commercegrid-sdk:2026.01.0.260223"
```
...
* `build/libs/criteo-api-commercegrid-sdk-2026.01.0.260223.jar`
...
------------ | ------------- | ------------- | -------------
*GatewayApi* | [**getCurrentApplication**](docs/GatewayApi.md#getCurrentApplication) | **GET** /2026-01/commerce-grid/me | 
